...
function drawCld(SY,SM) {
	var d,sObj,yDisplay
	var w = firstday(Number(SY),SM)
	var m = lastday(Number(SY),SM) 
	...
	//讓今日為藍底
	if((parseInt(SYear)==parseInt(SY)) && SMonth==SM){
...
function initial() {
	...
	document.CLD.date_y.value=SYear
...
<input type=hidden name=CY>
	<table width="150" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		<tr> 
			<td height="30"> 
				<table border="0" cellspacing="0" cellpadding="0" width="150">
					<tr> 
						<td class="dark_textcss"></td>
						<td> 
							<select onChange="changeCld()" class="formcss" name="SY">
								<SCRIPT language="JavaScript">
								for(i=1912;i<2050;i++) document.write('<option value='+i+'>'+(i))
								</SCRIPT>
							</select>
						</td>
		...
		<tr> 
			<td height="15"> 
				<div align="center">
					<a href="#" onClick="pushBtm('YU')"><img src="../image/year_back.gif" width="21" height="13" vspace="1" hspace="1" border="0"></a> 
					<a href="#" onClick="pushBtm('YD')"><img src="../image/year_next.gif" width="21" height="13" vspace="1" hspace="1" border="0"></a> 
					<a href="#" onClick="pushBtm('MU')"><img src="../image/month_back.gif" width="20" height="13" vspace="1" hspace="1" border="0"></a> 
					<a href="#" onClick="pushBtm('MD')"><img src="../image/month_next.gif" width="21" height="13" vspace="1" hspace="1" border="0"></a> 
					<a href="#" onClick="pushBtm('')"><img src="../image/today.gif" width="36" height="13" vspace="1" hspace="1" border="0"></a>
				</div>
			</td>
		</tr>
	</table>
