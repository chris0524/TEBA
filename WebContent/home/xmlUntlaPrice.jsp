...
sSQL = " select priceUnit from UNTLA_Price a "+
		...
		" and a.bulletindate = " + Common.sqlChar(Common.esapi(bulletinDate)) +
		"";
...
try {		
	...
	while (rs.next()){
		strXML.append("<record priceUnit=\""+Common.get(Common.checkGet(rs.getString("priceUnit"))) + "\""+
		" /> ");
	} 
} catch (Exception e) {
	e.printStackTrace();
