...
String sql =" select a.organID, a.organAName, a.organSName from SYSCA_Organ a where a.IsManager='Y'";
	   sql+=" and organID like '" + Common.get(Common.esapi(q_organID)) +"%' and (organAName like '%" + Common.get(Common.esapi(q_organName)) +"%' or organSName like '%" + Common.get(Common.esapi(q_organName)) + "%') "; 
//System.out.println("popOrgan2.jsp: "+ sql);
