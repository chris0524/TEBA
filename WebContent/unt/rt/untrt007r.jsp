...
<jsp:useBean id="obj" scope="request" class="unt.rt.UNTRT007R">
...
<form id="form1" name="form1" method="post" action="untrt007p.jsp" onSubmit="return checkField()" target="_blank">
...
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">權利減損單 <font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDInput" colspan="2" style="text-align:center;">
			<font color="red">核完章後請務必至「權利減少作業」進行入帳!!</font>
		</td>
	</tr>
	</table>
</td></tr></table>	
