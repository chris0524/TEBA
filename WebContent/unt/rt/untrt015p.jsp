...
<%
    ...
    env.setHttpFileName("UNTRT015R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/rt/untrt015r.jasper"));
	...
	//parms.put("subReportPath", this.getServletContext().getRealPath("/report/unt/rt/untrt015r_subreport.jasper"));
