...
<form id="form1" name="form1" method="post" action="untrt004p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
...
<table class="bg" width="102%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">權利財產卡 <font color="red">(A4 直式)</font></td>
	</tr>
	<tr>
