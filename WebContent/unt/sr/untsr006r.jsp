...
<jsp:useBean id="obj" scope="request" class="unt.sr.UNTSR006R">
...
<form id="form1" name="form1" method="post" action="untsr006p.jsp" onReset="init();" onSubmit="return checkField();" target="_blank">
<!--隱藏欄位===========================================================-->
...
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">國產署交換媒體檔－土地財產卡</td>
	</tr>
