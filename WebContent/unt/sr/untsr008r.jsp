...
<form id="form1" name="form1" method="post" action="untsr008p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank" autocomplete="off">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
		<td class="td_form" colspan="4" style="text-align:center">國產署交換媒體檔－增減結存表<font color="red">(A4橫式)</font></td>
	</tr>
	...
	<tr>
		...
		<td class="queryTDInput">
			<select class="field_Q" type="select" name="q_differenceKind" onchange="checkDifferenceKind();">
				<%=util.View.getOption("select codeID, codeName from SYSCA_Code where codeKindID='DFK' and codeID in ('110','120')","")%>
			</select>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="queryTDInput">
			...
			<span id = "P1" style="display:none;">
				<input class="field_Q" type="checkbox" name="q_enterorgKind1" value="2" ><font color="red">作業基金</font>
			</span>	
		</td>	
	</tr>
	...
	<tr>
		...
		<td class="queryTDInput">
			<input class="field_Q" type="text" name="q_reportYear" size="3" maxlength="3" value="<%=obj.getQ_reportYear()%>" onChange="YearPadLeft(this);changeReportType();">
		</td>
	</tr>		
	<tr>
