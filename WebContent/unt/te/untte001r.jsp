...
<jsp:useBean id="obj" scope="request" class="unt.te.UNTTE001R">
...
<form id="form1" name="form1" method="post" action="untte001p.jsp" onSubmit="return checkField()" target="_blank">
...
<table class="bg" width="50%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">核定繳納文稿主旨和說明 <font color="red">(A4 直式)</font></td>
	</tr>
	<tr>
