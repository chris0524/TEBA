...
<jsp:useBean id="obj" scope="request" class="unt.te.UNTTE004INSERT">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<jsp:useBean id="objList" scope="page" class="java.util.ArrayList"/>

<%
if("".equals(obj.getLndYYY())){
	String p_yymm=request.getParameter("p_yymm");
	obj.setQ_lndYYY(p_yymm);
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.te.UNTTE004INSERT)obj.queryOne();	
...
function queryOne(lndYYY,signNO){
...
function init(){
		setFormItem("confirm","clear","O");
		setFormItem("insert","update","R");
		setDisplayItem("spanInsert","H");
		setDisplayItem("spanUpdate","H");
		setDisplayItem("spanDelete","H");
		setDisplayItem("spanNextInsert","H");
		setDisplayItem("spanListPrint","H");
		setDisplayItem("spanDuplicateForm","H");
		setDisplayItem("spanListHidden","H");
}
</script>
</head>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><input class="field_Q" type=checkbox name='toggleAll' title="Select or deselect all records"></th>
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',2,false);" href="#">課稅年度</a></th>
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',3,false);" href="#">土地標示</a></th>
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',4,false);" href="#">課稅面積</a></th>
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',5,false);" href="#">地價稅額</a></th>
	</tr>
	</thead>
	<tbody id="listTBODY">
	<%
	boolean primaryArray[] = {false,true,true,false,false};
...
localButtonFireListener.whatButtonFireEvent = function(buttonName){
	switch (buttonName)	{
		case "clear":
			if (form1.caseEdit.value=="Y" && form1.queryGetRecords.value=="Y") {
				form1.state.value="queryAll";
				form1.submit();
			}			
			break;		
		case "update":
			document.form1.toggleAll.checked = true;
			CheckAll(document.form1, 'strKeys');
			break;				
	}
}
</script>
