...
{
	//alert('<%=storeDate%>');
	location.href='untte004update2.jsp?';
}
</script>
...
<table class="bg" width="80%" cellspacing="0" cellpadding="0" align="center"><tr><td>
    ...
    <tr>
        <td class="td_form" colspan="4" style="text-align:center">上傳地價稅課稅明細資料年度</td>
	</tr>
	<tr>
