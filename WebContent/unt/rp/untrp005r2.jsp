...
<form id="form1" name="form1" method="post" action="untrp005p2.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">
        	財產毀損報廢單<font color="red">(A4 橫式)</font>
        </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDLable">報廢單編號：</td>
		<td class="queryTDInput">
