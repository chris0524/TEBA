...
<jsp:useBean id="obj" scope="request" class="unt.rp.UNTRP008R">
...
<form id="form1" name="form1" method="post" action="untrp008p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">
        	財產減損單<font color="red">(A4 橫式)</font>
        </td>
	</tr>
	<tr>
