...
<form id="form1" name="form1" method="post" action="untrp007p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">
        	財產撥出單<font color="red">(A4 橫式)</font>
        </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDLable">撥出單編號：</td>
		<td class="queryTDInput">
