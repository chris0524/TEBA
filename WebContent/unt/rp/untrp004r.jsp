...
<%
	...
	//}
	//else{
	//	obj.setQ_proofDoc(new unt.ch.UNTCH_Tools()._getProofDoc(user.getOrganID(),"D3"));
	//}
...
<form id="form1" name="form1" method="post" action="untrp004p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">
        	財產增減值單<font color="red">(A4 橫式)</font>
        </td>
	</tr>
	<tr>
