...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA028F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.la.UNTLA028F)obj.queryOne();	
...
function queryOne(enterOrg,ownership,caseNo){
	...
	form1.reduceCaseNo.value=caseNo;
...
function gountla01617r(){
	if(form1.ownership.value==1){
		var url = "untla016p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=1" +
			"&q_caseNoS=" + form1.reduceCaseNo.value + "&q_caseNoE="+form1.reduceCaseNo.value +
			"&q_kind=4";
	}else if(form1.ownership.value==2){
		var url = "untla017p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=2" +
			"&q_caseNoS=" + form1.reduceCaseNo.value + "&q_caseNoE="+form1.reduceCaseNo.value +
			"&q_kind=4";
	}
	window.open(url);
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t2 CLASS="tab_border1">合併<br>減損單</td>		
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			[<input class="field_PRO" type="text" name="reduceCaseNo" size="10" maxlength="10" value="<%=obj.getReduceCaseNo()%>">]
