...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA009R">
...
<%
	...
	env.setHttpFileName("UNTLA009R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/la/untla009r.jasper"));
