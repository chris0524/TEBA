...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA042R">
...
<form id="form1" name="form1" method="post" action="untla042p.jsp" onSubmit="return checkField()" target="_blank">
...
<table class="bg" width="95%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">土地所有權狀備查簿<font color="red">(A4 橫式)</font></td>
	</tr>
