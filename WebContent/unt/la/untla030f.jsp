...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA030F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.la.UNTLA030F)obj.queryOne();	
...
insertDefault = new Array(
	...
	new Array("approveDoc","<%=Common.isoToUTF8(Common.checkGet(request.getParameter("approveDoc")))%>"),
//	new Array("manageNo",""),
//	new Array("summonsNo",""),
	new Array("closing","N")	
);
...
function goAddProof(){
	...
	url += "?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=" + form1.ownership.value +
		"&q_caseNoS=" + form1.addCaseNo.value + "&q_caseNoE="+form1.addCaseNo.value +
		"&q_kind=4";
	window.open(url);
}
...
function init(){
	...
	if(parse(form1.addCaseNo.value).length<=0){
		setFormItem("print1,print2,update,delete", "R");
		setFormItem("insert","O");
	}else{
		setFormItem("print1,print2,update,delete", "O");
	...
	if (form1.enterOrg.value!="<%=user.getOrganID()%>") {		
		setFormItem("insert,update,delete,print1,print2","R");
	}	
}
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		<td ID=t1 CLASS="tab_border2" HEIGHT="25" WIDTH=9%><a href="#" onClick="return checkURL('untla027f.jsp');">案件資料</a></td>
		<td ID=t2 CLASS="tab_border2" WIDTH=9%><a href="#" onClick="return checkURL('untla028f.jsp');">合併<br>減損單</a></td>		
		<td ID=t3 CLASS="tab_border2" WIDTH=9%><a href="#" onClick="return checkURL('untla029f.jsp');">合併<br>減損單明細</a></td>
		<td ID=t4 CLASS="tab_border1" WIDTH=9%>合併<br>增加單</td>
		<td ID=t5 CLASS="tab_border2" WIDTH=9%><a href="#" onClick="return checkURL('untla031f.jsp');">合併<br>增加單明細</a></td>
		<td ID=t6 CLASS="tab_border2" WIDTH=9%>合併增加單<br>管理資料</td>
		<td ID=t7 CLASS="tab_border2" WIDTH=9%><a href="#" onClick="return checkURL('untla034f.jsp');">分割<br>減損單</a></td>
		<td ID=t8 CLASS="tab_border2" WIDTH=9%><a href="#" onClick="return checkURL('untla035f.jsp');">分割<br>減損單明細</a></td>
		<td ID=t9 CLASS="tab_border2" WIDTH=9%><a href="#" onClick="return checkURL('untla036f.jsp');">分割<br>增加單</a></td>
		<td ID=t10 CLASS="tab_border2" WIDTH=9%><a href="#" onClick="return checkURL('untla037f.jsp');">分割<br>增加單明細</a></td>
		<td ID=t11 CLASS="tab_border2" WIDTH=10%>分割增加單<br>管理資料</td>
	</tr>
	<tr>
...
<input class="field_QRO" type="hidden" name="cause1" size="20" maxlength="40" value="<%=obj.getCause1()%>">
<input class="field_QRO" type="hidden" name="approveOrg" value="<%=obj.getApproveOrg()%>">
<input class="field_QRO" type="hidden" name="approveDate" size="7" maxlength="7" value="<%=obj.getApproveDate()%>">
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			[<input class="field_QRO" type="text" name="mergeDivision" size="15" maxlength="8" value="<%=obj.getMergeDivision()%>">]
		</td>
	</tr>	
	<tr>
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			[<input class="field_PRO" type="text" name="addCaseNo" size="15" maxlength="10" value="<%=obj.getAddCaseNo()%>">]
			&nbsp;　　　　　案名：[<input class="field_QRO" type="text" name="caseName" size="30" maxlength="25" value="<%=obj.getCaseName()%>">]
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<input class="field" type="text" name="proofDoc" size="15" maxlength="10" value="<%=obj.getProofDoc()%>">字
			[<input class="field_RO" type="text" name="proofNo" size="10" maxlength="10" value="<%=obj.getProofNo()%>">]號
...
<tr><td class="bg" style="text-align:center">
	...
	<input class="toolbar_default" type="button" followPK="false" name="print1" value="列印增加單" disabled="true" onClick="goAddProof();">&nbsp;|
	<input class="toolbar_default" type="button" followPK="false" name="print2" value="列印財產卡" disabled="true" onClick="goAddProofCard();">&nbsp;|	
</td></tr>
