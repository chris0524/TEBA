...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA036F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.la.UNTLA036F)obj.queryOne();	
...
function init(){
	...
	if(parse(form1.addCaseNo1.value).length<=0){
...
<!-- 	<td ID=t2 CLASS="tab_border2"><a href="#" onClick="return checkURL('untla028f.jsp');">合併<br>減損單</a></td>		
 ...
 -->		
		...
		<td ID=t9 CLASS="tab_border1">分割<br>增加單</td>
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			[<input class="field_PRO" type="text" name="addCaseNo1" size="15" maxlength="10" value="<%=obj.getAddCaseNo1()%>">]
