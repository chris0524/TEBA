...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA007F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.la.UNTLA007F)obj.queryOne();	
...
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		alertStr += checkLen(form1.viewDescribe, "勘查描述", 30);
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t7 CLASS="tab_border1"><a href="#">現場勘查</a></td>
		<td ID=t8 CLASS="tab_border2"><a href="#" onClick="return checkURL('untla008f.jsp');">稅籍資料</a></td>
	</tr>
	<tr>
	...
	<div id="formContainer">
	  <table class="table_form" width="100%" height="100%">
        <tr>
          ...
          <td class="td_form_white">[<input class="field_PRO" type="text" name="serialNo1" size="4" maxlength="3" value="<%=obj.getSerialNo1()%>">]</td>
        ...
        <tr>
          ...
          <td colspan="3" class="td_form_white"><input class="field" type="text" name="viewDescribe" size="40" maxlength="30" value="<%=obj.getViewDescribe()%>">
