...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA018F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.la.UNTLA018F)obj.queryOne();	
...
String tabs = uch._createTabData(uch._LA_ADJUST, 3);
%>
...
insertDefault = new Array(
	...
	new Array("proofDoc","<%=new unt.ba.UNTBA002F().getDefaultProofDoc(user.getOrganID(),"A3")%>"),
	new Array("closing","N")
);
...
function loadUntla024r(){
	var url = "untla024p.jsp?"
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
		    <table width="100%" height="100%" border="0">
              <tr>
                <td width="54%"><input class="field" type="text" name="proofDoc" size="15" maxlength="10" value="<%=obj.getProofDoc()%>">
&nbsp;字第 [
...
<tr><td class="bg" style="text-align:center">
	...
	<br>&nbsp;|
	<span id="spanUntla024r">
		<input class="toolbar_default" type="button" followPK="true" name="untla024r" value="列印增減值單" onClick="loadUntla024r();">&nbsp;|
	</span>
</td></tr>
