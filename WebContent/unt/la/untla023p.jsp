...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA023R">
...
<%
	...
	env.setHttpFileName("UNTLA023R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/la/untla023r.jasper"));
