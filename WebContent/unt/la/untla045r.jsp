...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA045R">
...
<form id="form1" name="form1" method="post" action="untla045p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">土地持分面積與使用面積不符差異明細表<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
