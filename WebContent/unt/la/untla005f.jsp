...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA005F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.la.UNTLA005F)obj.queryOne();	
...
if("true".equals(obj.getIsAddProof())){
	...
	tabs = uch_QUERY._createTabData(uch_QUERY._LA_ADD, 5);
...
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		alertStr += checkEmpty(form1.valueUnit,"公告地價");		
		//alertStr += checkInt(form1.valueUnit,"公告地價");
  ...
  <table class="table_form" width="100%" height="100%">
    <tr>
      ...
      <td colspan="3" class="td_form_white">
      	<input class="field_P" type="text" name="bulletinDate" size="5" maxlength="5" value="<%=obj.getBulletinDate()%>"> <input class="field_P" type="button" name="btn_bulletinDate" onclick="popBulletinDate('bulletinDate','1','Y')" value="..." title="公告年月輔助視窗">
      	<input class="field_QRO" type="HIDDEN" name="mergeDivision" value="<%=obj.getMergeDivision()%>">
      </td>
    </tr>
    <tr>
      <td class="td_form">公告地價：</td>
      <td colspan="3" class="td_form_white"><input class="field" type="text" name="valueUnit" size="10" maxlength="10" value="<%=obj.getValueUnit()%>">
        元/平方公尺 </td>
    </tr>
    <tr>
      <td class="td_form">適用期間：</td>
      <td colspan="3" class="td_form_white"> 起：[<input class="field_RO" type="text" name="suitDateS" size="7" maxlength="10" value="<%=obj.getSuitDateS()%>">]	    
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',2,false);" href="#">公告地價</a></th>
