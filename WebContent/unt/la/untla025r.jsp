...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA025R">
...
<body topmargin="10" >
<form id="form1" name="form1" method="post" action="untla025p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">土地公告地價差額清冊<font color="red">(A4 直式)</font></td>
	</tr>
	<tr>
