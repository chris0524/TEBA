...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA037F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.la.UNTLA037F)obj.queryOne();	
...
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		alertStr += checkEmpty(form1.addCaseNo1,"土地增加單-電腦單號");
...
<body topmargin="0" onLoad="whatButtonFireEvent('<%=obj.getState()%>');init();showErrorMsg('<%=obj.getErrorMsg()%>');changeSelect();">
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t10 CLASS="tab_border1">分割<br>增加單明細</td>
		<td ID=t11 CLASS="tab_border2"><a href="#" onClick="return checkURL('untla038f.jsp');">分割增加單<br>管理資料</a></td>
	</tr>
	<tr>
...
<tr><td class="bg">
	...
	<tr>
		<td class="td_form" colspan="4" style="text-align:center;">
			<input class="toolbar_default" type="button" name="btn_mergeReduce" onclick="popUntlaReduceDetail(form1.enterOrg.value,form1.ownership.value,form1.reduceCaseNo1.value);" value="分割減損單明細挑選" title="土地減損單明細輔助視窗" disabled=true>
		</td>
	</tr>
	<tr>
		...
		<td class="td_form_white" colspan="3">		
			...
			&nbsp;&nbsp;&nbsp;　電腦單號：
			[<input class="field_QRO" type="text" name="addCaseNo1" size="15" maxlength="10" value="<%=obj.getAddCaseNo1()%>">]
		</td>
	</tr>
	<tr>
