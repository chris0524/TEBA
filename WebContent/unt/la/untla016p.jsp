...
<jsp:useBean id="obj" scope="request" class="unt.la.UNTLA016R">
...
<%
	...
	env.setHttpFileName("UNTLA016R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/la/untla016r.jasper"));
