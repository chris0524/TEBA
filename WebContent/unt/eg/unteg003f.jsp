...
<jsp:useBean id="obj" scope="request" class="unt.eg.UNTEG003F">
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t3 CLASS="tab_border1">已入帳新增財產</a></td>
...
<tr>
	<td class="bg" style="text-align:center">
		...
		<jsp:include page="../../home/toolbar.jsp" /></td>
</tr>

<!--List區============================================================-->
<tr>
	<td class="bg">
	<div id="listContainer" style="width: 100%;	height: 480px; ">
