...
<jsp:useBean id="obj" scope="request" class="unt.eg.UNTEG002F">
...
function clickAddReport(){
	var sUrl = "../ch/untch001f01.jsp?enterOrg="+form1.enterOrg.value+"&engineeringNo="+form1.engineeringNo.value+"&q_engineeringNoName="+encodeURIComponent(form1.engineeringName.value);			
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		<td ID=t1 CLASS="tab_border2" HEIGHT="25"><a href="#"
			onClick="return checkURL('unteg001f.jsp');"><font color="red">*</font>營建工程資料維護</a></td>
		<td ID=t2 CLASS="tab_border1">未入帳新增財產</td>
...
<tr>
	<td class="bg" style="text-align:center">
		...
		|&nbsp;<input class="toolbar_default" type="button" followPK="false" name="addReport" value="增加單維護" onClick="clickAddReport();">
	...
	<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
		<thead id="listTHEAD">
			<tr>
				...
				<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',1,false);" href="#">增加單編號</a></th>
