...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP032R">
...
<form id="form1" name="form1" method="post" action="untmp032p.jsp" onReset="form1.q_enterOrg.value='<%=user.getOrganID()%>';changeAll();form1.q_propertyKind.value='';changeSelect();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center"></font>動產耐用年限已到期明細清冊<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="queryTDInput" colspan="3">	
			...
			<br>訖<%=util.View.getPopProperty("field_Q","q_propertyNoE",obj.getQ_propertyNoE(),obj.getQ_propertyNoEName(),"3,4,5")%>
		</td>
	</tr>	
	<tr>
