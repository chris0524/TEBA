...
<jsp:useBean id="obj" scope="Common.checkGet(request" class="unt.mp.UNTMP004F">
...
<!--Query區============================================================-->
<input type="hidden" name="querySelect" value="<%=Common.checkGet(request.getParameter("querySelect"))%>">
...
<tr><td class="bg" >
	...
	<table class="table_form" width="100%" height="10%">	
