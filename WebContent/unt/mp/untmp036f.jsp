...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP036F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.mp.UNTMP036F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t2 CLASS="tab_border2" HEIGHT="25"><a href="#" onClick="return checkURL('untmp026f.jsp');">增減值單明細資料</a></td>	
