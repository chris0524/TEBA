...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP037R">
...
<%
	...
	env.setHttpFileName("UNTMP037R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/mp/untmp037r.jasper"));
