...
<form id="form1" name="form1" method="post" action="untmp028p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">動產增減值單<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDInput" colspan="2" style="text-align:center;">
			<font color="red">核完章後請務必至「動產增減值作業」進行入帳!!</font>
		</td>
	</tr>
	<tr>
		<td class="queryTDInput" colspan="2" style="text-align:center;">
