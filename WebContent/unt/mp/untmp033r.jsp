...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP033R">
...
function checkField(){
	...
	alertStr += checkDate(form1.q_reduceDateS,"減損日期－起");
	alertStr += checkEmpty(form1.q_reduceDateS,"減損日期－起");
	alertStr += checkDate(form1.q_reduceDateE,"減損日期－訖");
	alertStr += checkEmpty(form1.q_reduceDateE,"減損日期－起");
...
<body topmargin="10" >
<form id="form1" name="form1" method="post" action="untmp033p.jsp" onReset="form1.q_enterOrg.value='<%=user.getOrganID()%>';changeAll();form1.q_propertyKind.value='';changeSelect();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center"></font>動產減損清冊<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
	    ...
	    <td class="queryTDInput">
            ...
            <script>getKeeper(form1.tempEnterOrg, form1.q_keepUnit, form1.q_keeper, '<%=obj.getQ_keepUnit()%>');</script>
          </select>
        </td>
	</tr>
