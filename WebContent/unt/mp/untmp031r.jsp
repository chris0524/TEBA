...
<body topmargin="10" onLoad="go('1');">

<form id="form1" name="form1" method="post" action="untmp031p.jsp" onReset="form1.q_enterOrg.value='<%=user.getOrganID()%>';changeAll();form1.q_propertyKind.value='';changeSelect();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">動產保管人清冊<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr style="display:none">	
		...
		<td class="queryTDInput">
			<select class="field_Q" type="select" name="q_keepBureau" onChange="getKeepUnit2(form1.q_enterOrg,form1.q_keepBureau,form1.q_keepUnit,form1.q_keeper,'N');">
