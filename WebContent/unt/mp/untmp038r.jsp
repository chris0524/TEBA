...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP038R">
...
<form id="form1" name="form1" method="post" action="untmp038p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">動產報廢殘值處理清冊<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
