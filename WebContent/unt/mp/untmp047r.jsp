...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP047R">
...
<body topmargin="10">
<form id="form1" name="form1" method="post" action="untmp047p.jsp" onSubmit="return checkField()" target="_blank">
...
<!--=============================================================================================================-->
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">動產毀損報廢減值單</td>
	</tr>
	<tr>
