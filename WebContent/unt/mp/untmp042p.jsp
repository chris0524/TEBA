...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP042R">
...
<%
	...
	env.setHttpFileName("UNTMP042R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/mp/untmp008r.jasper"));
