...
<jsp:useBean id="obj" scope="request" class="unt.mp.UNTMP009F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.mp.UNTMP009F)obj.queryOne();	
...
insertDefault = new Array(
	...
	new Array("proofDoc","<%=new unt.ba.UNTBA002F().getDefaultProofDoc(user.getOrganID(),"D4")%>"),
	//new Array("moveDate","<%=util.Datetime.getYYYMMDD()%>"),
	new Array("verify","N"),
	new Array("closing","N")	
);
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		//alertStr += checkEmpty(form1.moveDate,"移動日期");
...
function gountmp012r(){
	var url = "untmp012p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=" + form1.ownership.value +
		"&q_caseNoS=" + form1.caseNo.value + "&q_caseNoE="+form1.caseNo.value +
		"&q_kind=4";
	window.open(url);
}

function gountmp013r(){
	var url = "untmp013p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=" + form1.ownership.value +
		"&q_caseNoS=" + form1.caseNo.value + "&q_caseNoE="+form1.caseNo.value ;
	window.open(url);
}
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t2 CLASS="tab_border2"><a href="#" onClick="return checkURL('untmp010f.jsp');">移動單明細資料</a></td>		
	</tr>
	<tr>
...
<tr><td class="bg">
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			<input class="field" type="text" name="proofDoc" size="20" maxlength="20" value="<%=obj.getProofDoc()%>">&nbsp;&nbsp;字&nbsp;&nbsp;
			[<input class="field_RO" type="text" name="proofNo" size="20" maxlength="20" value="<%=obj.getProofNo()%>">]&nbsp;&nbsp;號
		</td>
	</tr>
	<tr>
