...
<form id="form1" name="form1" method="post" action="untmp006p.jsp" onSubmit="return checkField()" target="_blank">
<input type="hidden" name="userID" value="<%=user.getUserID()%>">
<input type="hidden" name="organID" value="<%=user.getOrganID()%>">
<input type="hidden" name="isOrganManager" value="<%=user.getIsOrganManager()%>">
<input type="hidden" name="isAdminManager" value="<%=user.getIsAdminManager()%>">			
<table class="bg" width="75%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">動產增加單 <font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDLable">核章明細表列印：</td>
		<td class="queryTDInput">
			<input class="field_Q" type="radio" name="q_detail" size="7"  value="Y" CHECKED>是
			&nbsp;&nbsp;
			<input class="field_Q" type="radio" name="q_detail" size="7"  value="N" >否
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDInput" colspan="2" style="text-align:center;">
			<font color="red">核完章後請務必至「動產主檔資料維護」進行入帳!!</font>
		</td>
	</tr>
	</table>
</td></tr></table>	
