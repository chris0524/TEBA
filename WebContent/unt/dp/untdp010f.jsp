...
<jsp:useBean id="obj" scope="request" class="unt.dp.UNTDP010F">
...
<div id="queryContainer" style="width:850px;height:300px;display:none">
	...
	<tr>
		<td class="queryTDLable" >是否現存：</td> 
	  	<td class="queryTDInput" colspan="3">
	  		<select class="field_Q" type="select" name="q_datastate">
        		<%=util.View.getTextOption("1;是;2;否", obj.getQ_datastate())%>
        	</select>
      	</td>
	</tr>
	<tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',1,false);" href="#">是否現存</a></th>		
	</thead>
	<tbody id="listTBODY">
	<%
...
//		out.write(util.View.getQuerylist(primaryArray,displayArray,objList,obj.getQueryAllFlag()));
	...
	if ("true".equals(obj.getQueryAllFlag()) && objList.size()==0){
		...
		while(it.hasNext()){
			...
			sbHEML.append(" <td class='listTD'>"+Common.checkGet(rowArray[20])+"</td>\n ");
			sbHEML.append(" <td class='listTD'>"+Common.checkGet(rowArray[21])+"</td></tr>\n ");
		}
	}
