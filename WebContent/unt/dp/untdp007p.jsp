...
<%
	...
	env.setHttpFileName("UNTDP007R");
	if ("1".equals(obj.getQ_report())) { // 財產大類
		env.setJasperFile(this.getServletContext().getRealPath("/report/unt/dp/untdp007r_1.jasper"));
	} else { // 財產明細
		env.setJasperFile(this.getServletContext().getRealPath("/report/unt/dp/untdp007r_2.jasper"));
	}
