...
<jsp:useBean id="obj" scope="request" class="unt.dp.UNTDP020R">
...
<form id="form1"  name="form1" method="post" action="untdp020p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="100%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">財產折舊攤提月報總表(代管資產)<font color="red">(A4 橫式)</font></td>
	</tr>
