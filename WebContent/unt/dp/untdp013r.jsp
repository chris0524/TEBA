...
*<br>修改作者　　修改日期　　　修改目的
*<br>--------------------------------------------------------
*<br>Jim.Lin    105/04/19    問題單990-A 新增淨值為選項
-->
<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8"%>
<%@ include file="../../home/head.jsp" %>
<jsp:useBean id="obj" scope="request" class="unt.dp.UNTDP013R">
...
<form id="form1"  name="form1" method="post" action="untdp013p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
	...
	<tr>
		<td>
			<table class="queryTable" cellspacing="0" cellpadding="0" border="1">
				<tr>
					<td class="td_form" colspan="4" style="text-align:center">財產折舊月報明細表(基金財產)<font color="red">(A4 橫式)</font></td>
				</tr>
				...
				<tr>
					...
					<td class="queryTDInput">
						<select class="field" type="select" name="q_page">
							...
							<option value="4">部門別單位+會計科目</option>
							<option value="3">財產大類</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="queryTDInput">
						<select class="field" type="select" name="q_propertyType">
							<%=util.View.getOption("select codeid, codename from SYSCA_CODE where codekindid = 'PTT' and codeid between 2 and 8 order by codeid"  ,"")%>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="queryTDLable">淨值為零是否列印：</td>
					<td class="queryTDInput">
							<select class="field"  name="q_netvalueCheck">
