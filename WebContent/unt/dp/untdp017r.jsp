...
<jsp:useBean id="obj" scope="request" class="unt.dp.UNTDP017R">
...
function checkTableExist(obj){
	if(obj.value.length==5){
		var x = getRemoteData('../../ajax/jsonUntdp017rMsg.jsp?q_deprYM='+obj.value);	
...
<body topmargin="10">
<form id="form1" name="form1" method="post" action="untdp017p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">財產折舊表(基金財產)<font color="red">(A4橫式)</font></td>
	</tr>
	<tr>
