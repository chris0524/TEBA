...
<form id="form1"  name="form1" method="post" action="untdp025p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="100%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">轉帳憑證黏存單(公務財產)<font color="red">(A4 直式)</font></td>
	</tr>
