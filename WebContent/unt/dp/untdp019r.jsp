...
<form id="form1"  name="form1" method="post" action="untdp019p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
	...
	<tr>
		<td>
			<table class="queryTable" cellspacing="0" cellpadding="0" border="1">
				...
				<tr>
				<tr>
					<td class="queryTDLable">是否列印說明資料：</td>
					<td class="queryTDInput">
						<select class="field" type="select" name="q_print">
