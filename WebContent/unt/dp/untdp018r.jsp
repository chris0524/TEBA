...
<form id="form1"  name="form1" method="post" action="untdp018p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
	...
	<tr>
		<td>
			<table class="queryTable" cellspacing="0" cellpadding="0" border="1">
				<tr>
			        <td class="td_form" colspan="4" style="text-align:center">財產折舊月報明細表(代管資產)<font color="red">(A4 橫式)</font></td>
				</tr>
