...
<form id="form1"  name="form1" method="post" action="untdp021p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="100%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">財產折舊攤提月報表(代管資產)<font color="red">(A4 橫式)</font></td>
	</tr>
    ...
    <tr style="display:none">
      ...
      <td class="queryTDInput"><select class="field_Q" type="select" name="q_differenceKind">
          <%=util.View.getOption("select codeID, codeName from SYSCA_Code where codeKindID='DFK'" ,"111")%>
        </select>      </td>
    </tr>
    <tr>
    <td class="queryTDLable">園區別 ：</td>
	<td class="queryTDInput"><select class="field" type="select" name="q_originalDeprPark" >
