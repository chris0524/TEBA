...
<jsp:useBean id="obj" scope="request" class="unt.pd.UNTPD015F">
...
function exportPopup(){
	if (form1.state.value=="exportAll") {
		...
		moshe.document.write('<br>輸出檔案下載 --> <a href="' + url + '">下載非消耗品盤點資料</a><br><br>');	
...
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="queryTDLable1" colspan="4" style="text-align:center">下載非消耗品盤點資料</td>
	</tr>
		<tr>
	...
	<tr>
		...
		<td class="queryTDInput" colspan="2">
			<select class="field" type="select" name="keepunit">
