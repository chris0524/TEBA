...
<jsp:useBean id="obj" scope="request" class="unt.pd.UNTPD020R">
...
<form id="form1" name="form1" method="post" action="untpd020p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="45%" cellspacing="0" cellpadding="0" align="center">
<tr><td>
<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">物品盤存報告表</td>
	</tr>
	<tr>
