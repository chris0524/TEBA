...
<jsp:useBean id="obj" scope="request" class="unt.pd.UNTPD016F">
    ...
    try {
	    if(enu.hasMoreElements()){
	     ...
	     //   obj.setFileName(fileName);
			...
			}else if(actionResult.indexOf("checkDataMatch") != -1){
				String tmp = actionResult.replaceAll("checkDataMatch,","");
				actionMessage += "第" +tmp+"筆之數量與盤點數量欄位比對不符";
				actionResult = "checkDataMatch";
			}else{
				actionMessage = "轉檔完成!!";
			}
...
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">上傳非消耗品盤點資料</td>
	</tr>
	<tr>
