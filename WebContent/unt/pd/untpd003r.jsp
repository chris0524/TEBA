...
<body topmargin="0" onLoad="init()">
	<form id="form1" name="form1" method="post" action="untpd003p.jsp"
		onSubmit="return checkField()" target="_blank">
		<table class="bg" width="80%" cellspacing="0" cellpadding="0"
			align="center">
			<tr>
				<td>
					<table class="queryTable" border="1">
						<tr>
							<td class="td_form" colspan="4" style="text-align: center" width='30%'>財產盤點清冊</td>
						</tr>
						<tr>
							<td class="queryTDLable"><font color="red">*</font>入帳機關：</td>
							<td class="queryTDInput"><%=util.View.getPopOrgan("field_RO", "q_enterOrg", 
									user.getOrganID(), user.getOrganName())%>
							</td>
						</tr>
						<tr>
							<td class="queryTDLable">財產區分別：</td>
							<td class="queryTDInput" colspan="3"><select class="field_Q"
								type="select" name="q_differenceKind">
					...
					.getSelectCtrlGroup(
						...
						<tr>
							...
							<td class="queryTDInput"><select class="field_Q"
								type="select" name="q_chengPageStyle">
						...
						<tr id = "titleName">
							...
							<select class="field_Q" type="select" name="q_titleName">
									<option value='1'>財產盤點清冊</option>
									<option value='2'>財產抽盤清冊</option>
							</select></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="queryTDInput" colspan="4" style="text-align: center;">
								<input class="toolbar_default" followPK="false" type="submit"
								name="querySubmit" value="確　　定"> <input
								class="toolbar_default" followPK="false" type="reset"
								name="queryCannel" value="取　　消">
							</td>
