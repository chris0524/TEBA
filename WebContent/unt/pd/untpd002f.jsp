...
<jsp:useBean id="obj" scope="request" class="unt.pd.UNTPD002F">
...
function init(){
	if (form1.state.value == 'addPDdateSuccess'){
		...
		//form1.q_keepBureau.value='';
		form1.q_keepUnit.value='';
		form1.q_keeper.value='';
		//form1.q_useBureau.value='';
...
function allCheckYN(){
	if (form1.q_allCheck.value == 'Y'){
		form1.q_libraryCheck.value='Y';
		form1.q_ownership.disabled=true;
		form1.q_differenceKind.disabled=true;
		form1.q_dataState.disabled=true;
		form1.q_propertyType.disabled=true;
		form1.q_propertyNoS.disabled=true;
		form1.q_propertyNoSName.disabled=true;
		form1.q_propertyNoE.disabled=true;
		form1.q_propertyNoEName.disabled=true;
		...
		form1.btn_q_keepUnit.disabled=true;
		form1.q_keeper.disabled=true;
		form1.btn_q_keeper.disabled=true;
		form1.q_useUnit.disabled=true;
		form1.btn_q_useUnit.disabled=true;
		form1.q_userNo.disabled=true;
		form1.btn_q_userNo.disabled=true;
		//form1.userNote.disabled=true;
		form1.q_place1.disabled=true;
		//form1.btn_q_place.disabled=true;
		//form1.q_place1Name.disabled=true;
		form1.q_place.disabled=true;
		//form1.q_keepBureau.disabled=true;
		//form1.q_useBureau.disabled=true;
	}else {
		form1.q_libraryCheck.value='N';
		form1.q_ownership.disabled=false;
		form1.q_differenceKind.disabled=false;
		form1.q_dataState.disabled=false;
		form1.q_propertyType.disabled=false;
		form1.q_propertyNoS.disabled=false;
		form1.q_propertyNoSName.disabled=false;
		form1.q_propertyNoE.disabled=false;
		form1.q_propertyNoEName.disabled=false;
		...
		form1.btn_q_keepUnit.disabled=false;
		form1.q_keeper.disabled=false;
		form1.btn_q_keeper.disabled=false;
		form1.q_useUnit.disabled=false;
		form1.btn_q_useUnit.disabled=false;
		form1.q_userNo.disabled=false;
		form1.btn_q_userNo.disabled=false;
		//form1.userNote.disabled=false;
		form1.q_place1.disabled=false;
		//form1.btn_q_place.disabled=false;
		//form1.q_place1Name.disabled=false;
		form1.q_place.disabled=false;
		//form1.q_keepBureau.disabled=false;
		//form1.q_useBureau.disabled=false;
	}
}
...
// 			valueStr += m2.options[i].value+",";
// 			}
// 		alert("value="+valueStr);

//     form1.q_sDestField= m2;
    
//     var valueStr1="";
// 	for (var i=0; i<document.getElementById("q_sDestField").options.length; i++){
// 		valueStr += document.getElementById("q_sDestField").options[i].value+",";
// 		}
// 	alert("value1="+valueStr1);
...
<input type="hidden" name="buttonName" value="">
	<tr>
        <td class="td_form" colspan="7" style="text-align:center">產生盤點資料</td>
	</tr>
	<tr>
...
<!--			<input class="field_Q" type="button" name="btn_q_enterOrg" onclick="popOrgan('q_enterOrg','q_enterOrgName','N')" value="..." title="機關輔助視窗">-->
	...
	<tr>
		...
		包含圖書：
			...
			<input type="checkbox" class="field_Q" name="q_engineerCheck">
		不含工程類財產
	...
	<tr>
        ...
        &nbsp;&nbsp;&nbsp;
        財產區分別：
		<select class="field" type="select" name="q_differenceKind">
	...
	<tr>
		...
		<td class="queryTDInput" colspan="3">
			<select class="field" type="select" name="q_propertyType">
				<%=util.View.getOption("select codeid, codename from SYSCA_CODE where codekindid = 'PTT' order by codeid"  ,"")%>
			</select>
		</td>
	</tr>
	<tr>
		...
		<td class="queryTDInput" colspan="3">
			起<%=util.View.getPopProperty("field_Q","q_propertyNoS",obj.getQ_propertyNoS(),obj.getQ_propertyNoSName(),"1,2,3,4,5&isLookup=Y")%>
			<br>
			訖<%=util.View.getPopProperty("field_Q","q_propertyNoE",obj.getQ_propertyNoE(),obj.getQ_propertyNoEName(),"1,2,3,4,5&isLookup=Y")%>
		</td>
</tr>
	<tr>
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			<br>
			使用註記
			<input type="text" class="field" name="q_userNote" value="" size="20">
			<!-- 存置地點
			<input class="field_Q" type="text" name="q_place1" size="10" maxlength="10" value="">
			...
			[<input class="field_RO" type="text" name="q_place1Name" size="20" maxlength="20" value="">]-->
