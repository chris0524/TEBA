...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU011R">
...
<%
	...
	env.setHttpFileName("UNTBU011R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/bu/untbu011r.jasper"));
