...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU003F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.bu.UNTBU003F)obj.queryOne();	
...
if("true".equals(obj.getIsAddProof())){
	...
	tabs = uch_QUERY._createTabData(uch_QUERY._BU_ADD, 3);
...
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		alertStr += checkLen(form1.notes1, "其它事項", 50);		
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white">
			[ <input class="field_RO" type="text" name="serialNo1" size="3" maxlength="3" value="<%=obj.getSerialNo1()%>"> ]		</td>
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			<input class="field" type="text" name="useArea" size="13" maxlength="10" value="<%=obj.getUseArea()%>">		　
			其他事項：
