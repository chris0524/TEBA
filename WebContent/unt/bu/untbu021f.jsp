...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU021F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.bu.UNTBU021F)obj.queryOne();	
...
insertDefault = new Array(
	...
	new Array("closing","N"),
	new Array("proofDoc","<%=new unt.ba.UNTBA002F().getDefaultProofDoc(user.getOrganID(),"B3")%>")
);
<!-- 檢查區，譬如：日期、空白... -->
function checkField(){
	var alertStr="";
...
function getEnterDate() {
	if (form1.verify.value=="Y") {
		if (form1.adjustDate.value=="") form1.adjustDate.value=getToday();
	}
}
...
function gountbu02425r(printType){
	if(printType == 'print1'){
		if(form1.ownership.value==1){
			var url = "untbu024p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=1" +
				"&q_caseNoS=" + form1.caseNo.value + "&q_caseNoE="+form1.caseNo.value +
				"&q_kind=4";
		}else if(form1.ownership.value==2){
			var url = "untbu025p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=2" +
				"&q_caseNoS=" + form1.caseNo.value + "&q_caseNoE="+form1.caseNo.value +
				"&q_kind=4";
		}
		window.open(url);
	}else if(printType =='print2'){
		var url = "untbu038p.jsp?q_enterOrg=" + form1.enterOrg.value 
...
function loadUntbu024r(){
	var url = "untbu024p.jsp?"
...
<!--Query區============================================================-->
<div id="queryContainer" style="width:765px;height:400px;display:none">
...
<table width="100%" cellspacing="0" cellpadding="0 valign="top">
	<tr>		
		...
		<td ID=t2 CLASS="tab_border2"><a href="#" onClick="return checkURL('untbu022f.jsp');">增減值單明細資料</a></td>
	</tr>
	<tr>
...
<tr><td class="bg" style="text-align:center">
	...
	<span id="spanUntbu024r">
		<input class="toolbar_default" type="button" followPK="true" name="untbu024r" value="列印增減值單" onClick="loadUntbu024r();">&nbsp;|
	</span>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',5,false);" href="#">入賬日期</a></th>
