...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU019R">
...
<%
	...
	env.setHttpFileName("UNTBU019R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/bu/untbu019r.jasper"));
