...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU024R">
...
<%
	...
	env.setHttpFileName("UNTBU024R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/bu/untbu024r.jasper"));
