...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU031R">
...
<%
    ...
    env.setHttpFileName("UNTBU031R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/bu/untbu031r.jasper"));
