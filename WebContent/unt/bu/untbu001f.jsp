...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU001F">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<jsp:useBean id="objList" scope="page" class="java.util.ArrayList"/>

<%
obj.checkDataForVerify();

if ("queryAll".equals(obj.getState())) {
	if ("false".equals(obj.getQueryAllFlag())){obj.setQueryAllFlag("true"); }
}else if ("queryOne".equals(obj.getState())) {
	obj = (unt.bu.UNTBU001F)obj.queryOne();	
...
insertDefault = new Array(
	...
	new Array("proofDoc","<%=new unt.ba.UNTBA002F().getDefaultProofDoc(user.getOrganID(),"B1")%>"),
...
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		if (form1.verify.value=="Y") {
			...
			if(form1.checkDataForVerify.value=="manageCount"){alert("至少要有1筆管理資料，請重新確認");return false;}
			if(form1.checkDataForVerify.value=="baseCount"){alert("至少要有1筆基地資料，請重新確認");return false;}
			if(form1.checkDataForVerify.value=="manageCount&baseCount"){alert("至少要有1筆管理資料和1筆基地資料，請重新確認");return false;}			
		}
...
function loadUntbu012r(){
	var url = "untbu012p.jsp?"
...
function loadUntbu013r(){
	var url = "untbu013p.jsp?"
			+ "organID=" + form1.organID.value
			+ "&q_enterOrg=" + form1.enterOrg.value
			+ "&q_ownership=" + form1.ownership.value 
			+ "&q_caseNoS=" + form1.caseNo.value 
...
<table style="display:none"><tr><td>
	...
	<input type="hidden" name="checkDataForVerify" value="<%=obj.checkDataForVerify()%>">
</td></tr></table>
...
<table STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t2 CLASS="tab_border2"><a href="#" onClick="return checkURL('untbu002f.jsp');">基本資料</a></td>		
		<td ID=t3 CLASS="tab_border2">管理資料</td>
		<td ID=t4 CLASS="tab_border2">樓層資料</td>
		<td ID=t5 CLASS="tab_border2">附屬建物</td>
		<td ID=t6 CLASS="tab_border2">基地資料</td>
		<td ID=t7 CLASS="tab_border2">共同使用資料</td>	
		<td ID=t8 CLASS="tab_border2">評定現值</td>	
	</tr>
	<tr>
...
<tr><td class="bg">
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">		
			...
			&nbsp;&nbsp;&nbsp;<font color="red">*</font>權屬：<select class="field_P" type="select" name="ownership"><%=util.View.getOnwerOption(obj.getOwnership())%></select>			
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">			<select class="field" type="select" name="writeUnit" >
		  ...
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;財產管理單位編號：<input class="field" type="text" name="manageNo" size="15" maxlength="10" value="<%=obj.getManageNo()%>"></td>
		</tr>
	<tr>
		...
		<td colspan="3" class="td_form_white" >
			...
			字	第 [<input class="field_RO" type="text" name="proofNo" size="10" maxlength="10" value="<%=obj.getProofNo()%>">] 號  		
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;傳票號數：<input class="field" type="text" name="summonsNo" size="15" maxlength="15" value="<%=obj.getSummonsNo()%>"></td>
		</tr>
        <tr>
...
<tr><td class="bg" style="text-align:center">
	...
	<span id="btnUntbu012r">
		<br>&nbsp;|
		<input class="toolbar_default" type="button" followPK="true" name="untbu012r" value="列印增加單" onClick="loadUntbu012r();">&nbsp;|
	</span>
	<span id="btnUntbu013r">
		<input class="toolbar_default" type="button" followPK="true" name="untbu013r" value="列印財產卡" onClick="loadUntbu013r();">&nbsp;|
	</span>
</td></tr>
