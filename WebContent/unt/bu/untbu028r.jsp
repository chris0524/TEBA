...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU028R">
...
<body topmargin="10" >
<form id="form1" name="form1" method="post" action="untbu028p.jsp" onSubmit="return checkField()" target="_blank">
...
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">建物所有權狀差異清冊<font color="red">(A4 直式)</font></td>
	</tr>
	<tr>
