...
<jsp:useBean id="obj" scope="request" class="unt.bu.UNTBU009F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.bu.UNTBU009F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t9 CLASS="tab_border1">現場勘查</td>
		<td ID=t10 CLASS="tab_border2"><a href="#" onClick="return checkURL('untbu010f.jsp');">稅籍資料</a></td>				
	</tr>
	<tr>
...
<script>whatButtonFireEvent('<%=obj.getState()%>');</script>
</body>
</html>
