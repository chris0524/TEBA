...
<jsp:useBean id="obj" scope="request" class="unt.ac.UNTAC001F">
...
function execViewData(index){
	...
	if(arrays[4] == '增加單'){			url = "../ch/untch001f02.jsp";
	}else if(arrays[4] == '移動單'){		url = "../ch/untch002f02.jsp";
	}else if(arrays[4] == '增減值單'){	url = "../ch/untch003f02.jsp";
	}else if(arrays[4] == '減損單'){		url = "../ch/untch004f02.jsp";
	}else if(arrays[4] == '處理單'){		url = "../mp/untmp022f.jsp";
	}
