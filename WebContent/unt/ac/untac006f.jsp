...
<jsp:useBean id="obj" scope="request" class="unt.ac.UNTAC006F">
	...
	<table class="table_form" width="100%" height="50%">
		<tr>
			<td class="queryTDInput" style="text-align:center;">
				<input class="toolbar_default" followPK="false" type="submit" name="querySubmit" value="執行關帳回復">
			</td>			
		</tr>
	</table>
	</div>
