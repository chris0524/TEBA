...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF003F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.rf.UNTRF003F)obj.queryOne();	
...
if("true".equals(obj.getIsAddProof())){
	...
	tabs = uch_QUERY._createTabData(uch_QUERY._RF_ADD, 3);
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form">整筆面積(㎡)：</td>
		<td class="td_form_white" colspan="2">
			<input class="field" type="text" name="area" size="13" maxlength="13" value="<%=obj.getArea()%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td class="td_form_white"><input class="field" type="text" name="owner" size="30" maxlength="30" value="<%=obj.getOwner()%>">	</td>
	  <td class="td_form">管理機關：</td>
	  <td class="td_form_white" colspan="2"><%=util.View.getPopOrgan("field","manageOrg",obj.getManageOrg(),obj.getManageOrgName(),"Y")%> </td>
    </tr>
	<tr>
      <td class="td_form">備註：</td>
      <td class="td_form_white"colspan="4"><textarea name="notes" cols="25" rows="4" class="field"><%=obj.getNotes()%></textarea>
      </td>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',3,false);" href="#">基地所有人</a></th>
	</thead>
	<tbody id="listTBODY">
	<%
