...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF006R">
...
<form id="form1" name="form1" method="post" action="untrf006p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">土地改良物增加單<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDInput" colspan="2" style="text-align:center;">
			<font color="red">核完章後請務必至「土地改良物主檔資料維護」進行入帳</font>
		</td>
	</tr>
