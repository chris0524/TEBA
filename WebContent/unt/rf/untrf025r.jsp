...
<body topmargin="10">
<form id="form1" name="form1" method="post" action="untrf025p.jsp" onSubmit="return checkField()" target="_blank">
...
<!--=============================================================================================================-->
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">土地改良物毀損報廢減值單</td>
	</tr>
	<tr>
