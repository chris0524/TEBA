...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF022R">
...
<form id="form1" name="form1" method="post" action="untrf022p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center"><font></font>土地改良物毀損報廢單<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
