...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF014F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.rf.UNTRF014F)obj.queryOne();	
...
insertDefault = new Array(
	...
	new Array("proofDoc","<%=new unt.ba.UNTBA002F().getDefaultProofDoc(user.getOrganID(),"C3")%>"),
	new Array("closing","N")
);
<!-- 檢查區，譬如：日期、空白... -->
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		alertStr += checkEmpty(form1.adjustDate,"增減值日期");
...
function gountrf01718r(printName){
	if(printName == 'print1'){
		if(form1.ownership.value==1){
		var url = "untrf017p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=1" +
			"&q_caseNoS=" + form1.caseNo.value + "&q_caseNoE="+form1.caseNo.value +
			"&q_kind=4";
		}else if(form1.ownership.value==2){
			var url = "untrf018p.jsp?organID="+form1.organID.value+"&q_enterOrg=" + form1.enterOrg.value + "&q_ownership=2" +
			"&q_caseNoS=" + form1.caseNo.value + "&q_caseNoE="+form1.caseNo.value +
			"&q_kind=4";
		}
		window.open(url);
	}else if(printName == 'print2'){
		var url = "untrf025p.jsp?q_enterOrg=" + form1.enterOrg.value 
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td ID=t2 CLASS="tab_border2"><a href="#" onClick="return checkURL('untrf015f.jsp');">增減值單明細資料</a></td>	
	</tr>
	<tr>
...
<tr><td class="bg" style="text-align:center">
	...
	<span id="spanUntrf017r">
		<input class="toolbar_default" type="button" followPK="true" name="untrf017r" value="列印增減值單" onClick="loadUntrf017r();">&nbsp;|
	</span>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',5,false);" href="#">增減值日期</a></th>
