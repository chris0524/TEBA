...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF005R">
...
<%
	...
	env.setHttpFileName("UNTRF005R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/rf/untrf005r.jasper"));
