...
<form id="form1" name="form1" method="post" action="untrf007p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
...
<table class="bg" width="100%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">土地改良物財產卡<font color="red">(A4 直式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="queryTDInput" colspan="3">		     
			起<%=util.View.getPopProperty("field_Q","q_propertyNo1",obj.getQ_propertyNo1(),obj.getQ_propertyNo1Name(),"111")%>&nbsp;~&nbsp;
			訖<%=util.View.getPopProperty("field_Q","q_propertyNo2",obj.getQ_propertyNo2(),obj.getQ_propertyNo2Name(),"111")%>
		</td>
	</tr>
	<tr>
