...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF016F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.rf.UNTRF016F)obj.queryOne();	
...
<html>
<head>
<title>土地改良物增減值作業現有資料明細新增輔助視窗</title>
...
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		if(form1.q_cause.value=="2"){
		    alertStr += checkEmpty(form1.q_cause,"整建說明");
		}
...
<!--批次設定區============================================================-->
<div id="gountrf016f" style="position:absolute;z-index: 25;left:0;top :0;width:350px;height:150px;display:none">
	<iframe id="gountrf016fFrame"  style="position:absolute;z-index: -1;left:0;top :0;width:100%;height:100%;"></iframe>	
	...
	<tr> 
		...
		<td class="queryTDInput">
			<input class="field_Q" type="text" name="q_cause2" size="12" maxlength="12" value="<%=obj.getQ_cause2()%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="queryTDInput" colspan="4" style="text-align:center;">
			...
			<input class="toolbar_default" followPK="false" type="button" name="queryCannel" value="取　　消" onClick="queryHidden('gountrf016f');initC();">
		</td>
	</tr>
	</table>
</div>
...
<tr><td class="bg"> 
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
	  		[<input class="field_QRO" type="text" name="propertyNo" size="10" maxlength="10" value="<%=obj.getPropertyNo()%>"  onBlur="getUNTRFAttachment();">]
	  		<input class="field_RO" type="hidden" name="btn_propertyNo" onclick="popProperty('propertyNo','propertyName','111')" value="..." title="財產編號輔助視窗">
	   		&nbsp;分號：[<input class="field_RO" type="text" name="serialNo" size="7" maxlength="7" value="<%=obj.getSerialNo()%>" onBlur="getUNTRFAttachment();">]
	...
	<tr>
		...
		<td class="td_form_white">
			原始入帳價值：[<input class="field_RO" type="text" name="originalBV" size="12" maxlength="12" value="<%=obj.getOriginalBV()%>">]
		<br>
			計量數：[<input class="field_RO" type="text" name="measure" size="12" maxlength="12" value="<%=obj.getMeasure()%>">]
...
<tr><td class="bg" style="text-align:center">
	...
	<input class="toolbar_default" type="button" followPK="false" name="batchInsertBut" value="批次設定" onClick="queryShow('gountrf016f');">&nbsp;|
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',4,false);" href="#">帳面價值</a></th>
	</thead>
	<tbody id="listTBODY">	
	<%
