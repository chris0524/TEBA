...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF011R">
...
<form id="form1" name="form1" method="post" action="untrf011p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">土地改良物移交清冊<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="queryTDInput">
            ...
            <option value='3' >縣有</option>
            <option value='5' >鄉鎮市有</option>
			</select>
		</td>
	</tr>
	<tr>
