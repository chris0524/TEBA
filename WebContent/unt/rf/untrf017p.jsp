...
<jsp:useBean id="obj" scope="request" class="unt.rf.UNTRF017R">
...
<%
	...
	env.setHttpFileName("UNTRF017R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/rf/untrf017r.jasper"));
