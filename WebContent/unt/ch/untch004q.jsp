...
<%
unt.ch.UNTCH004Q obj = (unt.ch.UNTCH004Q)request.getAttribute("UNTCH004Q");
%>
<head>
...
function clearPage() {
	...
	<tr name="div_q_detail">
		...
		<td class="queryTDInput" colspan="3">
			<%=new unt.ch.UNTCH_Tools().getReduceCause("field_Q","q_cause",obj.getQ_cause(),obj.getQ_causeName(),"2,4","changecause();")%>
		</td>		
	</tr>
	<tr name="div_q_proof">
