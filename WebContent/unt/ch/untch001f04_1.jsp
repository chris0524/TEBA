...
<jsp:useBean id="obj" scope="request" class="unt.ch.UNTCH001F04">
...
if("111".equals(checkStr3)){
	...
	if("true".equals(obj.getIsAddProof())){	tabs = uch._createTabData(uch._BU_ADD, 12);
	}else if("query".equals(obj.getIsAddProof())){
											uch_QUERY._setupViewType(uch_QUERY._queryOrMaintenance);
											tabs = uch_QUERY._createTabData(uch_QUERY._BU_ADD, 11);
	}else if("_query".equals(obj.getIsAddProof())){
											uch._setupViewType(uch._query);
											tabs = uch._createTabData(uch._BU_ADD, 11);
	}else if("_maintenance".equals(obj.getIsAddProof())){
											uch._setupViewType(uch._maintenance);
											tabs = uch._createTabData(uch._BU_ADD, 11);
	}else{									uch._setupViewType(uch._queryOrMaintenance);
	...
	if("true".equals(obj.getIsAddProof())){	tabs = uch._createTabData(uch._MP_ADD, 9);
	}else if("query".equals(obj.getIsAddProof())){
											uch_QUERY._setupViewType(uch_QUERY._queryOrMaintenance);
											tabs = uch_QUERY._createTabData(uch_QUERY._MP_ADD, 8);
	}else if("_query".equals(obj.getIsAddProof())){
											uch._setupViewType(uch._query);
											tabs = uch._createTabData(uch._MP_ADD, 5);
	}else if("_maintenance".equals(obj.getIsAddProof())){
											uch._setupViewType(uch._maintenance);
											tabs = uch._createTabData(uch._MP_ADD, 5);
	...
	if("true".equals(obj.getIsAddProof())){	tabs = uch._createTabData(uch._VP_ADD, 6);
	}else if("query".equals(obj.getIsAddProof())){
											uch_QUERY._setupViewType(uch_QUERY._queryOrMaintenance);
											tabs = uch_QUERY._createTabData(uch_QUERY._VP_ADD, 5);
	}else if("_query".equals(obj.getIsAddProof())){
											uch._setupViewType(uch._query);
...
<tr><td class="bg" style="text-align:center;display:none;">		
	...
	<input class="field_QRO" type="text" name="serialNoS" value="<%=obj.getSerialNoS() %>">
	<input class="field_QRO" type="text" name="serialNoE" value="<%=obj.getSerialNoE() %>">
