...
<jsp:useBean id="obj" scope="request" class="unt.ch.UNTCH008F">
...
function init(){
    ...
    var dcc1 = new DataCouplingCtrlPlus(form1.form1.userOrganID, form1.KeepUnitQuickly, form1.KeepUnit, form1.UseUnitQuickly, form1.UseUnit, true, false);
    var dcc2 = new DataCouplingCtrlPlus(form1.form1.userOrganID, form1.KeeperQuickly, form1.Keeper, form1.UserQuickly, form1.User, true, false); 
    var dcc3 = new DataCouplingCtrlPlus(form1.form1.userOrganID, form1.q_keeperQuickly, form1.q_keeper, form1.q_keepUnitQuickly, form1.q_keepUnit, true, false); 
...
function openBatchUpdate() {
    ...
    + "&queryAllFlag=true";
    window.open("../../unt/ch/untch009f.jsp?" + urlParms);
}
    ...
    <tr>
        ...
        <td class="queryTDInput" colspan="3">
            ...
            <%=View.getSelectCtrlGroup("select a.keeperno, CASE a.incumbencyyn WHEN 'N' THEN a.keepername + '(停用)' ELSE a.keepername END AS keepername from UNTMP_KEEPER a LEFT OUTER JOIN SYSAP_EMP b ON a.enterorg = b.organid AND a.keeperno = b.empid where 1=1 and enterorg = '" + user.getOrganID() + "' order by case a.incumbencyyn when 'Y' then 'Y' else 'N' end DESC,convert(varchar,keepername) ", 
              "field_QRO", "form1", "q_keeper", "q_keeperQuickly", user.getKeeperno()) %>
        </td>
    </tr>
    <tr>
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
    <tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">財產存置地點維護</td></tr><tr><td class="tab_line1"></td></tr>
</TABLE>
