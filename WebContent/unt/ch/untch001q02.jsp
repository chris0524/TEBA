...
<body topmargin="0" onLoad="init();">
	...
	<tr name="div_q_proof">
	  <td class="queryTDLable" colspan="3">入帳機關：</td>
	...
	<tr name="div_q_proof">
		...
		<td class="queryTDInput" colspan="3">
       		<input class="field_Q" type="text" name="q_engineeringNo" size="10" maxlength="11" value="<%=untbuQuery.getQ_engineeringNo()%>" onchange="queryEngineeringName('q_enterOrg','q_engineeringNo');">
			...
			[<input class="field_PRO" type="text" name="q_engineeringNoName" size="20" maxlength="50" value="<%=untbuQuery.getQ_engineeringNoName()%>">]
       	</td>
	</tr>
	<tr name="div_q_detail">
		...
		<td class="queryTDInput">
       		<input class="field_Q" type="checkbox" name="q_cb_originalDeprUnitCB" size="10" maxlength="10" onclick="checkQ_originalDeprUnitCB();" <%= ("Y".equals(untbuQuery.getQ_originalDeprUnitCB())?"checked":"") %> >
	...
	<tr name="div_q_detail">
	  ...
	  <td class="queryTDLable" id="td1">入帳：</td>
	   <td class="queryTDInput"  id="td2">
	...
	<tr name="div_q_detail">
		...
		<td class="queryTDInput" colspan="3">
			型式：<input class="field_Q" type="text" name="q_specification" size="40" maxlength="40" value="<%=untbuQuery.getQ_specification()%>">&nbsp;
