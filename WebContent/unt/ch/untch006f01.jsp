...
<jsp:useBean id="obj" scope="request" class="unt.ch.UNTCH001F08">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<%
obj.setProgType("UNTCH006F01");
...
String caseNo_Reduce = Common.checkGet(request.getParameter("caseNo_Reduce"));
