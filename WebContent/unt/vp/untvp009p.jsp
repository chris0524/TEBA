...
<%
	...
	env.setHttpFileName("UNTVP009R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/vp/untvp009r.jasper"));
	...
	parms.put("subReportPath", this.getServletContext().getRealPath("/report/unt/vp/untvp009r_subreport.jasper"));
