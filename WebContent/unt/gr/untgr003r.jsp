...
<body topmargin="10" >
<!--頁籤區=============================================================-->
<form id="form1" name="form1" method="post" action="untgr003p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">土地增減單月報表<font color="red">(A4橫式)</font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="queryTDInput">
			<input class="field" type="text" name="q_reportYM" size="5" maxlength="10" value="<%=obj.getQ_reportYM()%>">
		</td>
	</tr>	
	<tr>
