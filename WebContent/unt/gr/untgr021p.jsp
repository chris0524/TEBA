...
<%
	...
	env.setHttpFileName("UNTGR021R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/gr/untgr021r.jasper"));
	...
	String ownershipName="珍貴動產、不動產增減結存表";
// 	110.07.14 問題單2151 報表移除權屬
// 	if(obj.getQ_ownership().equals("1")){
// 		ownershipName = "國有珍貴動產、不動產增減結存表";
// 	}else if(obj.getQ_ownership().equals("2")){
// 		ownershipName = "直轄市有珍貴動產、不動產增減結存表";
// 	}else if(obj.getQ_ownership().equals("3")){
// 		ownershipName = "縣有珍貴動產、不動產增減結存表";
// 	}else if(obj.getQ_ownership().equals("4")){
// 		ownershipName = "市有珍貴動產、不動產增減結存表";
// 	}else if(obj.getQ_ownership().equals("5")){
// 		ownershipName = "鄉(鎮、市)有珍貴動產、不動產增減結存表";
// 	} else {
// 		ownershipName = "珍貴動產、不動產增減結存表";
// 	}
