...
try{
	...
	env.setHttpFileName("UNTGR030R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/gr/untgr030r.jasper"));
...
// 	parms.put("reportName", TCGHCommon.getSYSCODEName(obj.getQ_ownership(), "OWA") + "珍貴動產、不動產目錄");
	parms.put("reportName", "珍貴動產、不動產目錄");
