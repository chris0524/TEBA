...
<jsp:useBean id="obj" scope="request" class="unt.gr.UNTGR019R">
...
<form id="form1" name="form1" method="post" action="untgr019p.jsp" onSubmit="return checkField();" target="_blank">
<input type="hidden" name="isAdminManager" value="<%=user.getIsAdminManager()%>">
<input type="hidden" name="organID" value="<%=user.getOrganID()%>">			
<input type="hidden" name="q_valuable" value="N">	
<input type="hidden" name="q_reportType" value="1">	
<input type="hidden" name="q_reportMonth" value="01">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center">
<tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">財產目錄總表<font color="red">(A4橫式)</font></td>
	</tr>
	<tr id="TR001">
