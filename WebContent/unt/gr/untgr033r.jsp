...
<body topmargin="10">
<form id="form1" name="form1" method="post" action="untgr033p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">地籍地段代碼異動清冊<font color="red">(A4橫式)</font></td>
	</tr>
	<tr>
