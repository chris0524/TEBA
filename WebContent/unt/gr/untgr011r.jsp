...
function checkTableExist(){
	...
	if(yyy.length==3){
		var x = getRemoteData('../../ajax/jsonUntgr011rMsg.jsp?q_deprYYY='+yyy);	
...
<form id="form1" name="form1" method="post" action="untgr011p.jsp" onSubmit="return checkField();" target="_blank">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center">
<tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">財產目錄(普通公務機關用)<font color="red">(A4橫式)</font></td>
	</tr>
	<tr id="TR001">
	...
	<tr>
		...
		<td class="queryTDInput">
			<input class="field_Q" type="text" name="q_reportYear" size="3" maxlength="3" value="<%=obj.getQ_reportYear()%>" onChange="addAnyChar(this, 3, '0');" onblur="//checkTableExist();">
		</td>
	</tr>
	<tr>
