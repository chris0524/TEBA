...
try{
	...
	env.setHttpFileName("UNTGR019R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/gr/untgr019r.jasper"));
	...
	parms.put("reportName", TCGHCommon.getSYSCODEName(obj.getQ_ownership(), "OWA") + "財產目錄總表");
