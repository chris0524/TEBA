...
<jsp:useBean id="obj" scope="request" class="unt.gr.UNTGR030R">
...
<form id="form1" name="form1" method="post" action="untgr030p.jsp" onSubmit="return checkField();" target="_blank">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center">
<tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">珍貴動產、不動產目錄<font color="red">(A4橫式)</font></td>
	</tr>
	<tr id="TR001">
	...
	<tr>
		...
		<td class="queryTDInput">
			<select class="field_Q" type="select" name="q_differenceKind" onchange="checkDifferenceKind();">
 				<%=util.View.getOption("select codeid, codename from SYSCA_CODE where codekindid = 'DFK' and codeid in ('110','120','112') order by codeid", obj.getQ_differenceKind())%>			
			</select>
		</td>
	</tr>
	<tr>
