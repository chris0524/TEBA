...
<jsp:useBean id="obj" scope="request" class="unt.gr.UNTGR021R">
...
<form id="form1" name="form1" method="post" action="untgr021p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank" autocomplete="off">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
		<td class="td_form" colspan="4" style="text-align:center">珍貴動產、不動產增減結存表<font color="red">(A4橫式)</font></td>
	</tr>
