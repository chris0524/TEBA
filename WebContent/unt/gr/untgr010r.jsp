...
<form id="form1" name="form1" method="post" action="untgr011p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
		...
		<td class="queryTDInput">
            ...
            <%=util.View.getTextOption("1;財產;2;物品;",obj.getQ_propertyKind1())%>
			</select>
		</td>
	</tr>
	<tr>
