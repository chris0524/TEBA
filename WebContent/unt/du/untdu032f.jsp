...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU032F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU032F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">動產增減值作業-增減值單資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		<td class="td_form"><font color="red">*</font>填單日期：</td>
