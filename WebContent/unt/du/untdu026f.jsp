...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU026F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU026F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">土地改良物增減值作業-增減值單資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
