...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU029F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU029F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">非消耗品增減值作業-增減值單資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			字第 
			<input class="field" type="text" name="proofNo" size="10" maxlength="10" value="<%=obj.getProofNo()%>">
			號&nbsp;&nbsp;&nbsp;
			傳票號數：
	...
	<tr>
    	...
    	<td colspan="3" class="td_form_white">
			<select class="field" type="select" name="verify" onChange="getAdjustDate();">
