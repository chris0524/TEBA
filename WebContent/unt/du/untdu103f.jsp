...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU103F">
...
<div id="gountmp027f" style="position:absolute;z-index: 25;left:0;top :0;width:500px;height:100px;display:none">
	...
	<table class="queryTable"  border="1">
		...
		<td class="queryTDInput" colspan="3">	
			<%=util.View.getPopProperty("field_Q","newPropertyNo",obj.getNewPropertyNo(),obj.getNewPropertyNoSName(),"2")%>
	  </td>
	</tr>	
	<tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	if ("true".equals(obj.getQueryAllFlag()) && objList.size()==0){
		...
		while(it.hasNext()){
			...
			sbHEML.append(" <tr class='listTR' onmouseover=\"this.className='listTRMouseover'\" onmouseout=\"this.className='listTR'\" onClick=\"queryOne('"+rowArray[0]+"','"+rowArray[6]+"','"+rowArray[7]+"','"+rowArray[1]+"','"+rowArray[2]+"','"+rowArray[3]+"','"+rowArray[8]+"');\">\n ");						
			sbHEML.append(" <td class='listTD'>"+counter+".</td> ");
			sbHEML.append(" <td class='listTD'><input type='checkbox' class='field_Q' name='sKeySet' value=\""+Common.checkGet(rowArray[0])+","+Common.checkGet(rowArray[1])+","+Common.checkGet(rowArray[2])+","+Common.checkGet(rowArray[3])+","+Common.checkGet(rowArray[4])+","+Common.checkGet(rowArray[5])+"\" onclick=\"Toggle(this, document.form1, 'sKeySet');\"" + isCheck + ">\n");
			...
			sbHEML.append(" <td class='listTD'>"+Common.checkGet(rowArray[8])+"</td></tr>\n ");
		}
	}
