...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU014F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU014F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">動產資料修改-主檔明細資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<input class="field" type="text" name="oldPropertyNo" size="10" maxlength="11" value="<%=obj.getOldPropertyNo()%>">
			原財產分號：
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			條碼：
			<input class="field" type="text" name="barCode" size="15" maxlength="11" value="<%=obj.getBarCode()%>">
			盤點日期：
	...
	<tr>
		...
		<br>
			...
			<select class="field" type="select" name="originalKeepUnit" onChange="getKeeper(form1.enterOrg, this, form1.originalKeeper, '' ,'N');changeKeep();">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			<input class="field" type="button" name="btn_damageDate" onclick="popCalndar('damageDate');changeDamageDate();" value="..." title="萬年曆輔助視窗">
			毀損報局屆滿日：
			<input class="field" type="text" name="damageExpire" size="7" maxlength="7" value="<%=obj.getDamageExpire()%>">
			已毀損待處理註記：
			<input class="field"  type="checkbox" name="damageMark" value="1" <%=obj.getDamageMark()%>>
		</td>
	</tr>
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			　減損原因：
			<select class="field" type="select" name="reduceCause" onChange="changeSelect();">
				<%=util.View.getOption("select codeID, codeName from SYSCA_Code where codeKindID='CAC'", obj.getReduceCause())%>
			</select>
			　其它說明：
			<input class="field" type="text" name="reduceCause1" size="15" maxlength="20" value="<%=obj.getReduceCause1()%>">
		</td>
	</tr>
	<tr>
		...
		<br>
			累計折舊調整年月：
			<input class="field" type="text" name="accumDeprYM" size="5" maxlength="5" value="<%=obj.getAccumDeprYM()%>">　
			累計折舊調整金額：
