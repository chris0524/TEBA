...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU015F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU015F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		<td ID=t1 CLASS="tab_border1" HEIGHT="25">土地主檔資料維護-增加單資料</td>
	</tr>
	<tr>
...
<tr><td class="bg">
	  ...
	  <table class="table_form" width="100%" height="100%">
        <tr>
          ...
          <td colspan="3" class="td_form_white">
			...
			電腦單號：[<input class="field_PRO" type="text" name="caseNo" size="15" maxlength="10" value="<%=obj.getCaseNo()%>">]
        </tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" class="td_form_white" ><input class="field" type="text" name="proofDoc" size="15" maxlength="10" value="<%=obj.getProofDoc()%>">
			字 第 <input class="field" type="text" name="proofNo" size="10" maxlength="10" value="<%=obj.getProofNo()%>">號
			&nbsp;&nbsp;
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			...
			入帳日期：<%=util.View.getPopCalndar("field","enterDate",obj.getEnterDate())%>              
			月結：
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
          	<input class="field" type="text" name="mergeDivision" size="15" maxlength="8" value="<%=obj.getMergeDivision()%>">
		</td>
	</tr>
	<tr>
