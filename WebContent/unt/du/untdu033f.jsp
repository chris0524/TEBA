...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU033F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU033F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">動產減少作業 -減少單資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
