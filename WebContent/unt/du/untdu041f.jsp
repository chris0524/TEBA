...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU041F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU041F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">非消耗品減少作業-減損單明細資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			...
			原物品編號：
			<input class="field" type="text" name="oldPropertyNo" size="12" maxlength="12" value="<%=obj.getOldPropertyNo()%>">
			原分號：
	...
	<tr>
		<td class="td_form">會計科目：</td>
		<td class="td_form_white" colspan="3">		
			<input class="field" type="text" name="accountingTitle" size="40" maxlength="20" value="<%=obj.getAccountingTitle()%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<font color="red">*</font>
			數量：<input class="field" type="text" name="adjustBookAmount" size="7" maxlength="7" value="<%=obj.getAdjustBookAmount()%>">
			　<font color="red">*</font>
			總價：
