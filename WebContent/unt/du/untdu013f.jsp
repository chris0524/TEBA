...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU013F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU013F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">動產資料維護-主檔資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		<td class="td_form" ><font color="red">*</font>分號起~訖：</td>
		<td class="td_form_white" colspan="3">
			起：<input class="field" type="text" name="serialNoS" size="7" maxlength="7" value="<%=obj.getSerialNoS()%>">&nbsp;~&nbsp;
			訖：<input class="field" type="text" name="serialNoE" size="7" maxlength="7" value="<%=obj.getSerialNoE()%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		　	其他說明：
			<input class="field" type="text" name="fundsSource1" size="20" maxlength="20" value="<%=obj.getFundsSource1()%>">
		<br>
			補助金額：
	...
	<tr>
		...
		<font color="red">*</font>原始入帳數量：
			<input class="field" type="text" name="originalAmount" size="15" maxlength="7" value="<%=obj.getOriginalAmount()%>" onChange="set_property_value();">
		<br>
			原始入帳單價：
			<input class="field" type="text" name="originalUnit" size="15" maxlength="13" value="<%=obj.getOriginalUnit()%>" onChange="check_property_type();set_property_value();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<font color="red">*</font>原始入帳總價：
	  		<input class="field" type="text" name="originalBV" size="15" maxlength="15" value="<%=obj.getOriginalBV()%>" onChange="set_propety_lbv();">
	  	<br>
			原始入帳摘要：
			<input class="field" type="text" name="originalNote" size="30" maxlength="20" value="<%=obj.getOriginalNote()%>">
		<br>
			帳面數量：
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			折舊方法：
			<select name="deprMethod" class="field" type="select" onChange="set_depreciation();">
				<%=util.View.getOption("select codeID, codeName from SYSCA_Code where codeKindID='DEP' ", obj.getDeprMethod())%>
        	</select>
		<br>
			原始預留殘值：<input class="field" type="text" name="scrapValue" size="10" maxlength="10" value="<%=obj.getScrapValue()%>">
		<br>
			使用年限截止年月：<input class="field" type="text" name="useEndYM" size="10" maxlength="" value="<%=obj.getUseEndYM()%>">
			攤提年限截止年月：<input class="field" type="text" name="apportionEndYM" size="10" maxlength="20" value="<%=obj.getApportionEndYM()%>">
		</td>
	</tr>
	<tr>
