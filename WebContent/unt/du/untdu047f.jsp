...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU047F">
...
String originalDeprPark = ""; //園區
	...
	if ("exportAll".equals(actionType)) {  //Excel匯出
    	...
    	originalDeprPark = Common.checkGet(mr.getParameter("originalDeprPark"));
		...
		obj.setOriginalDeprPark(originalDeprPark);
...
function exportPopup(){
	...
	if (form1.actionType.value=="exportAll") {
		...
		moshe.document.write('<br>輸出檔案下載 --> <a href="' + url + '">下載建物資料釐正資料</a><br><br>');	
		moshe.document.write('</body></html>');	
...
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
		<td class="queryTDLable1" colspan="3" style="text-align:center">建物資料釐正－Excel匯出</td>		
	</tr>		
	<tr>
	...
	<tr>
		<td class="queryTDLable1" colspan="3" style="text-align:center">建物資料釐正－Excel匯入</td>		
	</tr>		
	<tr>
		<td class="queryTDLable">入帳機關：</td>
		<td class="queryTDInput" colspan="2">
