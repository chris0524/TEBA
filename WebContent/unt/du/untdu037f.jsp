...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU037F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU037F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">非消耗品增減值作業-增減值單明細資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			&nbsp;&nbsp;&nbsp;
			原物品編號：
			<input class="field" type="text" name="oldPropertyNo" size="12" value="<%=obj.getOldPropertyNo()%>">
			&nbsp;&nbsp;&nbsp;
			原分號：
