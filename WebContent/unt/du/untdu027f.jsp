...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU027F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU027F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">土地改良物減少作業-減損單資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<select class="field_RO" type="select" name="verify">
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			<%=util.View.getPopCalndar("field","demolishDate",obj.getDemolishDate())%>
			原因： 
			<input class="field" type="text" name="unusableCause" size="50" maxlength="50" value="<%=obj.getUnusableCause()%>">
		</td>
	</tr>
	<tr>
