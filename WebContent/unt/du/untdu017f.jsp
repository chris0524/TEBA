...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU017F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU017F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		<td ID=t1 CLASS="tab_border1" HEIGHT="25">土地減少作業-減損單資料</td>
	</tr>
	<tr>
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<input class="field" type="text" name="mergeDivision" size="10" maxlength="10" value="<%=obj.getMergeDivision()%>">     	
		</td>
	</tr>
	<tr>
