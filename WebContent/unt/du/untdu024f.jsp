...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU024F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU024F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">建物資料維護-減損主檔資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<select class="field" type="select" name="verify" onChange="io_control(this);">
