...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU016F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU016F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		<td ID=t1 CLASS="tab_border1" HEIGHT="25">土地主檔資料維護-基本資料</td>
	</tr>
	<tr>
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			原分號：<input class="field" type="text" name="oldSerialNo" size="7" maxlength="7" value="<%=obj.getOldSerialNo()%>"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			...
			財產取得文號：<input class="field" type="text" name="sourceDoc" size="18" maxlength="20" value="<%=obj.getSourceDoc()%>">
		</td>
	</tr>
	<tr>
		...
		管理機關：<%=util.View.getPopOrgan("field","manageOrg",obj.getManageOrg(),obj.getManageOrgName(),"Y")%>
		使用情形：
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
		總面積：
		<input name="originalArea" type="text" class="field" value="<%=obj.getOriginalArea()%>" size="12" maxlength="10">
		<br>
		權利分子：
		<input class="field" type="text" name="originalHoldNume" size="9" maxlength="10" value="<%=obj.getOriginalHoldNume()%>">
		權利分母：<input class="field" type="text" name="originalHoldDeno" size="9" maxlength="10" value="<%=obj.getOriginalHoldDeno()%>">
		權利範圍面積(㎡)：<input class="field" type="text" name="originalHoldArea" size="9" maxlength="10" value="<%=obj.getOriginalHoldArea()%>">
		</td>
	</tr>
	<tr>
		<td class="td_form">目前面積：</td>
		<td class="td_form_white" colspan="3">
			總面積：<input class="field" type="text" name="area" size="12" maxlength="10" value="<%=obj.getArea()%>"><br>
			權利分子：<input class="field" type="text" name="holdNume" size="9" maxlength="10" value="<%=obj.getHoldNume()%>">
			權利分母：<input class="field" type="text" name="holdDeno" size="9" maxlength="10" value="<%=obj.getHoldDeno()%>">
			權利範圍面積(㎡)：<input class="field" type="text" name="holdArea" size="9" maxlength="10" value="<%=obj.getHoldArea()%>">
		</td>
	</tr>
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			<br><font color="red">*</font>單價：
			<input class="field" type="text" name="originalUnit" size="13" maxlength="16" value="<%=obj.getOriginalUnit()%>">
			總價：<input class="field" type="text" name="originalBV" size="15" maxlength="15" value="<%=obj.getOriginalBV()%>">
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			單價：<input class="field" type="text" name="bookUnit" size="13" maxlength="16" value="<%=obj.getBookUnit()%>">
			總價：<input class="field" type="text" name="bookValue" size="15" maxlength="15" value="<%=obj.getBookValue()%>">
		</td>
	</tr>
	<tr>
	...
	<td class="td_form">減損資料：</td>
		<td colspan="3" class="td_form_white">
			減損日期：<input class="field" type="text" name="reduceDate" size="15" maxlength="7" value="<%=obj.getReduceDate()%>">
			<br>減損原因：
			...
			其他說明：<input class="field" type="text" name="reduceCause1" size="20" maxlength="20" value="<%=obj.getReduceCause1()%>">
		</td>
	</tr>
	<tr>
	...
	<td class="td_form">處分作業：</td>
		<td class="td_form_white" colspan="3"> 方式：
	...
	<tr>
		...
		<td colspan="3" class="td_form_white">
			<input class="field" type="text" name="notes1" size="50" maxlength="60" value="<%=obj.getNotes1()%>">
		</td>
	</tr>
	<tr>
