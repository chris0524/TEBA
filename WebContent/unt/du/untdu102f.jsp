...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU102F">
...
if ("queryAll".equals(obj.getState())) {
	...
	//obj = (unt.du.UNTDU102F)obj.queryOne();
	...
	<table class="queryTable"  border="1">
		<tr>
			...
			<td class="queryTDInput" width="70%" height="5%">
				<input class="field_Q" type="text" name="q_newPropertyNo" size="10" maxlength="10" value="<%=obj.getQ_newPropertyNo()%>" onBlur="getProperty('q_newPropertyNo','q_newPropertyNoName','111','N');">
				<input class="field_Q" type="button" name="btn_q_propertyNo" onclick="popProperty('q_newPropertyNo','q_newPropertyNoName','111')" value="..." title="財產編號輔助視窗">
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	boolean displayArray[] = {false,true,true,false,true,true,true};
