...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU034F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU034F)obj.queryOne();	
...
<div id="queryContainer" style="width:400px;height:400px;display:none">
	...
	<input class="field_Q" type="hidden" name="q_chengClass" size="10" maxlength="10" value="<%=obj.getQ_chengClass()%>">
	<tr>
	...
	<tr>
		...
		<td class="queryTDInput">
			<input class="field_Q" type="text" name="q_lotNo" size="11" maxlength="11" value="<%=obj.getQ_lotNo()%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="queryTDInput">
			<input class="field_Q" type="text" name="q_serialNo" size="11" maxlength="11" value="<%=obj.getQ_serialNo()%>">
		</td>
	</tr>
	<tr>
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">土地增減值作業-增減值單</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" width="32%" colspan="3">
			...
			權屬：
			<select class="field_P" type="select" name="ownershipName">
	...
	<tr>
		<td class="td_form" width="10%">填單日期：</td>
		<td class="td_form_white" width="32%" colspan="3">
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<input class="field" type="text" name="writeUnit" size="30" maxlength="30" value="<%=obj.getWriteUnit()%>">
			財產管理單位編號：
			<input class="field" type="text" name="manageNo" size="10" maxlength="10" value="<%=obj.getManageNo()%>">
		</td>
	</tr>
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			字第<input class="field" type="text" name="proofNo" size="10" maxlength="10" value="<%=obj.getProofNo()%>">號
			傳票號數：
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
            <select class="field" type="select" name="approveOrg">
