...
<jsp:useBean id="obj" scope="request" class="unt.du.UNTDU038F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.du.UNTDU038F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr><td ID=t1 CLASS="tab_border1" HEIGHT="25">建物減少作業-減損單明細資料</td></tr>
</TABLE>
<!--頁籤區=============================================================-->
...
<tr><td class="bg">
	...
	<tr>
		<td class="td_form">可報廢日期：</td>
		<td class="td_form_white" colspan="3">
			<%=util.View.getPopCalndar("field","permitReduceDate",obj.getPermitReduceDate())%>
			已使用年月：
			<input class="field" type="text" name="useYear" size="10" value="<%=obj.getUseYear()%>">年
			<input class="field" type="text" name="useMonth" size="10" value="<%=obj.getUseMonth()%>">個月
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<br>	
			...
			&nbsp;
			其他說明：
			<input class="field" type="text" name="cause1" size="30" maxlength="20" value="<%=obj.getCause1()%>">
		<br>
			報廢(損)後處理情形：
	...
	<tr>
		<td class="td_form">門牌：</td>
			<td class="td_form_white" colspan="3">
				...
				<input class="field" name="doorPlate4" type="text" value="<%=obj.getDoorPlate4()%>" size="30">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			...
			權狀字號：
			<input class="field" type="text" name="proofDoc" size="18" maxlength="20" value="<%=obj.getProofDoc()%>">
		</td>
	</tr>
	<tr>
		...
		<td class="td_form_white" colspan="3">		
			主面積(㎡)：
			<input class=field type="text" name="CArea" size="9" maxlength="9" value="<%=obj.getCArea()%>">
			附屬面積(㎡)：
			<input class="field" type="text" name="SArea" size="9" maxlength="9" value="<%=obj.getSArea()%>">
			總面積(㎡)：
	...
	<tr>
		...
		<br>
			殘餘價值：
			<input class="field" type="text" name="scrapValue1" size="10" value="<%=obj.getScrapValue1()%>">
			應攤提折舊總額：
			<input class="field" type="text" name="deprAmount" size="10" value="<%=obj.getDeprAmount()%>">
		<br>
			攤提年限截止年月：
			<input class="field" type="text" name="apportionEndYM" size="10" value="<%=obj.getApportionEndYM()%>">
			月提折舊金額：
			<input class="field" type="text" name="monthDepr" size="10" value="<%=obj.getMonthDepr()%>">
		<br>
			累計折舊調整年月：
			<input class="field" type="text" name="accumDeprYM" size="10" value="<%=obj.getAccumDeprYM()%>">
			累計折舊調整金額：
			<input class="field" type="text" name="accumDepr" size="10" value="<%=obj.getAccumDepr()%>">
		<br>
			累計折舊：
			<input class="field" type="text" name="accumDepr1" size="10" value="<%=obj.getAccumdepr1()%>">
		</td>
	</tr>	
	<tr>
