...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE004F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.ne.UNTNE004F)obj.queryOne();	
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		<td ID=t1 CLASS="tab_border2" HEIGHT="25"><a href="#" onClick="return checkURL('untne001f.jsp');">增加單資料</a></td>		
