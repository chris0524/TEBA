...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE036R">
...
<%
	...
	env.setHttpFileName("UNTNE036R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/ne/untne036r.jasper"));
