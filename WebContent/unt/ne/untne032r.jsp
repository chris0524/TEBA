...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE032R">
...
<form id="form1" name="form1" method="post" action="untne032p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
...
<!--==================================================================-->
	...
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">物品減損清冊<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
