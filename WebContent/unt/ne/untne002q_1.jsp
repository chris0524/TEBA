...
<table class="queryTable"  border="1">
	...
	<tr>
		...
		<td class="queryTDInput"> 
		起<input class="field_Q" type="text" name="q_oldSerialNoS" size="20" maxlength="30" value="<%=untneAddProofQuery.getQ_oldSerialNoS()%>">&nbsp;~&nbsp;
		訖<input class="field_Q" type="text" name="q_oldSerialNoE" size="20" maxlength="30" value="<%=untneAddProofQuery.getQ_oldSerialNoE()%>">
		</td>
