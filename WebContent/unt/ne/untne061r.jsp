...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE061R">
...
<form id="form1" name="form1" method="post" action="untne061p.jsp" onReset="check_reset();" onSubmit="return checkField()" target="_blank">
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">物品折舊沖回明細表<font color="red"></font></td>
	</tr>
	<tr>
