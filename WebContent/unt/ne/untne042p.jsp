...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE042R">
...
<%
	...
	env.setHttpFileName("UNTNE042R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/ne/untne007r.jasper"));
