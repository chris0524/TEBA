...
String sql=" select a.organID, a.organAName, a.organSName from SYSCA_Organ a where 1=1 and IsManager='Y' " +
 			" and a.organID like '" + Common.esapi(Common.get(q_organID)) +"%' and (a.organAName like '%" + Common.esapi(Common.get(q_organName)) +"%' or a.organSName like '%" + Common.esapi(Common.get(q_organName)) + "%') ";
