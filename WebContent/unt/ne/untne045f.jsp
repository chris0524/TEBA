...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE045F">
...
function link_printData(){
	//var url="untne042p.jsp?userID="+form1.userID.value;
	//untne042p = window.open(url);
	var url="";
	if (document.all.q_labelType[0].checked) {
		form1.action="untne042p.jsp";
	}else{
    	form1.action="untne043p.jsp";
    }	
    queryHidden('goUntne045f');
}

function link_printData_S(){
	var url="untne043p.jsp?userID="+form1.userID.value;
	untne043p = window.open(url);
}
...
<div id="queryContainer" style="width:750px;height:300px;display:none">
	...
	<% request.setAttribute("UNTNE044Q",obj);%>
	<jsp:include page="untne044q.jsp" />
</div>
<!--列印選擇============================================================-->
<div id="goUntne045f" style="position:absolute;z-index: 25;left:0;top :0;width:300px;height:80px;display:none">
	<iframe id="goUntne045fFrame"  style="position:absolute;z-index: -1;left:0;top :0;width:100%;height:100%;"></iframe>	
	...
	<tr>
		<td class="queryTDInput" colspan="2" style="text-align:center;">
			...
			<input class="toolbar_default" followPK="false" type="button" name="queryCannel" value="取　　消" onClick="queryHidden('goUntne045f');init();">
		</td>
	</tr>
	</table>
</div>
...
<tr><td class="bg" style="text-align:center">
	...
	<input class="toolbar_default" type="button" followPK="false" name="printData_L" value="列　印" onClick="queryShow('goUntne045f');">&nbsp;|
</td></tr>
<tr><td>
...
<!--List區============================================================-->
<tr><td class="bg">
<div id="listContainer" style="width: 100%;	height: 570px;">
