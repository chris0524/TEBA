...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE004F_2">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<jsp:useBean id="objList" scope="page" class="java.util.ArrayList"/>
<!-- 保留第一頁查詢條件與頁數使用 -->
<jsp:useBean id="obj2" scope="request" class="unt.ne.UNTNE003F_2">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.ne.UNTNE004F_2)obj.queryOne();	
