...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE003F_1">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.ne.UNTNE003F_1)obj.queryOne();	
...
function init(){
	...
	setDisplayItem("spanInsert,spanNextInsert,spanUpdate,spanClear,spanConfirm,spanopenUpdate","H");
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>		
		...
		<td ID=t7 CLASS="tab_border2"><a href="#" onClick="return checkURL('untne058f_1.jsp');">移動紀錄</a></td>
	</tr>
	<tr>
	...
	<tr>
	    ...
	    <td class="td_form_white" colspan="3">
			保管單位
				...
				<input class="field_RO" type="button" name="btn_q_keepUnit" onclick="popUnitNo(form1.organID.value,'keepUnit','useUnit')" value="..." title="單位輔助視窗">
				&nbsp;&nbsp;&nbsp;保管人
		        ...
		        <input class="field_RO" type="button" name="btn_q_keeper" onclick="popUnitMan(form1.organID.value,'keeper','userNo')" value="..." title="人員輔助視窗">
				<br>
				使用單位
				...
				<input class="field_RO" type="button" name="btn_q_useUnit" onclick="popUnitNo(form1.organID.value,'useUnit','keepUnit')" value="..." title="單位輔助視窗">
				&nbsp;&nbsp;&nbsp;使用人
		        ...
		        <input class="field_RO" type="button" name="btn_q_userNo" onclick="popUnitMan(form1.organID.value,'userNo','keeper')" value="..." title="人員輔助視窗">
		        &nbsp;&nbsp;&nbsp;
			          使用註記：
				...
				<input class="field_RO" type="button" name="btn_q_place" onclick="popPlace(form1.organID.value,'place1','placeName')" value="..." title="存置地點輔助視窗">
