...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE023R">
...
<form id="form1" name="form1" method="post" action="untne023p.jsp" onSubmit="return checkField()" target="_blank">
<!--隱藏欄位===========================================================-->
...
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">物品廢品處理清冊 <font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
