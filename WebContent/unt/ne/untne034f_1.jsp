...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE034F_1">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.ne.UNTNE034F_1)obj.queryOne();	
...
if ("true".equals(obj.getQueryAllFlag())){
	...
	if (!objList.isEmpty()) {
		...
		obj.setLotNo(((String[])objList.get(0))[3]);
...
function queryOne(enterOrg,ownership,propertyNo,lotNo,serialNo1,differenceKind){
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>		
		<td ID=t2 CLASS="tab_border2"><a href="#" onClick="return checkURL('untne002f_1.jsp');">基本資料</a></td>		
