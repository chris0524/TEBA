...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE002F_2">
...
try {
	...
	if ("queryAll".equals(obj.getState())) {
		...
		obj = (unt.ne.UNTNE002F_2)obj.queryOne();	
...
function init(){
	...
	setDisplayItem("spanInsert,span_btn01,span_btn02,span_btn03,spanNextInsert","H");
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>		
		...
		<td ID=t4 CLASS="tab_border2"><a href="#" onClick="return checkURL('untne034f_2.jsp');">附屬設備</a></td>
...
<div id="queryContainer" style="width:1100px;height:400px;display:none">
	...
	<jsp:include page="untne002q_2.jsp" />
</div>
...
-->			<input class="field" type="hidden" name="valuable" value="N" >
	...
	<tr>
		...
		<td class="td_form_white" colspan="3">
			<input class="field_P" type="text" name="propertyNo" size="12" maxlength="12" value="<%=obj.getPropertyNo()%>" onc="getProperty('propertyNo','propertyNoName','','NE')">
