...
String strHTML;
strHTML = obj.getPropertyList(new Boolean("false"), fromAdd);
%>
...
function selectProperty(propertyNo,propertyName,propertyType,propertyUnit,material,limitYear, memo, editID, editDate){
	...
	if (isObj(opener.changePropertyNo)) {
		...
		<table class="queryTable"  border="1">
			<tr>
				...
				<td class="queryTDInput">
					<input class="field_Q" type="text" name="q_propertyNo" size="11" maxlength="12" value="<%=obj.getQ_propertyNo()%>">
				</td>
			</tr>	
			<tr>
...
<!--List區============================================================-->
<tr><td class="bg" >
<div id="listContainer" style="width: 100%;	height: 300px;	overflow: auto;	scrollbar-base-color:#eeeeee;">
