...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE051R">
...
function checkField(){
	...
	if(alertStr.length!=0){ 
		...
		if (document.all.q_labelType[0].checked) {
    		form1.action="untne051p.jsp";
    	}else{
    		form1.action="untne052p.jsp";
    	}
		return true;
	}
}
...
<table class="bg" width="102%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">物品標籤(配合標籤機)<font color="red">(A4 直式)</font></td>
	</tr>
	<tr>
