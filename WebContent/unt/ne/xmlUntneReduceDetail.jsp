...
String serialNo = Common.formatFrontZero(request.getParameter("serialNo"),7);
...
sSQL =  " select a.serialNo, b.propertyUnit, b.material, b.limitYear, a.otherPropertyUnit, a.otherMaterial, a.otherLimitYear, "+
		" a.lotNo, a.propertyName1 , a.enterDate , a.buyDate ,a.reduceDate, "+
		" a.propertyKind , a.fundType , a.valuable , a.accountingTitle ,"+
		" a.differenceKind,a.caseSerialNo,a.userNote,a.place1,"+
		...
		" a.useYear, a.useMonth, a.permitReduceDate, a.oldPropertyNo , a.oldSerialNo "+
		" from untne_ReduceDetail a, SYSPK_PropertyCode2 b "+
		" where 1=1 and a.enterOrg = b.enterOrg and a.propertyNo = b.propertyNo "+
		...
		" and a.differenceKind 	= " + Common.sqlChar(Common.esapi(differenceKind)) +
		" " ;
...
try {		
	...
	while (rs.next()){
		...
		" enterDate=\""+objCommon.get(rs.getString("enterDate")) + "\"\n"+
		...
		" permitReduceDate=\""+objCommon.get(rs.getString("permitReduceDate")) + "\"\n"+
		" oldPropertyNo=\""+objCommon.get(rs.getString("oldPropertyNo")) + "\"\n"+
		" oldSerialNo=\""+objCommon.get(rs.getString("oldSerialNo")) + "\"\n"+
		" differenceKind=\""+objCommon.get(rs.getString("differenceKind")) + "\"\n"+
		" caseSerialNo=\""+objCommon.get(rs.getString("caseSerialNo")) + "\"\n"+
		" userNote=\""+objCommon.get(rs.getString("userNote")) + "\"\n"+
		" place1=\""+objCommon.get(rs.getString("place1")) + "\"\n"+
		" check=\""+"Y"+ "\"\n"+
		" /> ");
	} 
	if(check==""){
