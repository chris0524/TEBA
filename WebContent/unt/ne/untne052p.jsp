...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE052R">
...
<%
	...
	env.setHttpFileName("UNTNE052R");
	env.setJasperFile(this.getServletContext().getRealPath("/report/unt/mp/untmp052r.jasper"));
