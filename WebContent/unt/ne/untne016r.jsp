...
<form id="form1" name="form1" method="post" action="untne016p.jsp" onSubmit="return checkField()" target="_blank">
<table class="bg" width="70%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	<table class="queryTable"  border="1">
	<tr>
        <td class="td_form" colspan="2" style="text-align:center">物品損毀報廢單<font color="red">(A4 橫式)</font></td>
	</tr>
	<tr>
