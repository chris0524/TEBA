...
function init() {
	if ("Y"=="<%=obj.getBatchInsertFlag()%>") {
		...
		opener.queryOne(form1.enterOrg.value,form1.ownership.value,form1.propertyNo.value,"<%=obj.getSerialNo()%>",form1.differenceKind.value);
