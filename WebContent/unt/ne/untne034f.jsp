...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE034F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.ne.UNTNE034F)obj.queryOne();	
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tbody id="listTBODY">
	<%
	boolean primaryArray[] = {true,true,true,true,true,false,false,false,false,true};
	boolean displayArray[] = {false,false,false,false,true,true,true,true,true,false};
