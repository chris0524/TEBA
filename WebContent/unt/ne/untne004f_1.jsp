...
<jsp:useBean id="obj" scope="request" class="unt.ne.UNTNE004F_1">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (unt.ne.UNTNE004F_1)obj.queryOne();	
...
if ("true".equals(obj.getQueryAllFlag())){
	...
	if (!objList.isEmpty()) {
		...
		obj.setDifferenceKind(((String[])objList.get(0))[10]);
		obj.setPropertyNo(((String[])objList.get(0))[2]);
		obj.setSerialNo(((String[])objList.get(0))[3]);
		obj.setSerialNo1(((String[])objList.get(0))[4]);
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>		
		...
		<td ID=t5 CLASS="tab_border1">附屬設備明細</td>
...
<tr><td class="bg" style="text-align:center">
	...
	<inputtype="hidden" name="listContainerActiveRowId" value="<%=obj.getListContainerActiveRowId()%>">	
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tbody id="listTBODY">
	<%
	boolean primaryArray[] = {true,true,true,true,true,false,false,false,false,false,true};
	boolean displayArray[] = {false,false,false,false,true,true,true,true,true,true,false};
