//*********************************************
//函數功能：找出UNTLA_building資料表裡的propertyNo,propertyName,serialNo
//參　　數：
//一.strType：查詢依据[PN:財產編號;SN:地號]
//二.datastate：資料狀庇
//三.file_name：查無資料清空欄位['N'：不清空]
//*********************************************
function get_Pub_Building(file_name ,strType ,datastate ){
	var alertStr = "", chkStr = "";
	var i = 0, j=0;
	...
	*/
	...
	if ( strType == 'PN' ){
		...
		if(xmlDoc.load("../../home/xml_Pub_Building.jsp?"+queryValue)){
