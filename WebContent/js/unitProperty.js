...
//*********************************************
function popUntlaReduceDetail(enterOrg,ownership,reduceCaseNo){
...
//	var windowLeft=(document.body.clientWidth-400)/2+250;
	var windowTop=300;
	var windowLeft=100;
	prop=prop+"width=900,height=295,";
...
//*********************************************
function popUntlaReduceDetail1(enterOrg,ownership,reduceCaseNo,mergeDivisionDate){
