...
<jsp:useBean id="obj" scope="request" class="sys.st.SYSST005R">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<%
if ("exportAll".equals(obj.getState())) {
	obj.setFilestoreLocation(this.getServletContext().getRealPath("/sys/st/templates/sysst005r.xls"));
	obj.genExcelFile();
...
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">市有不動產使用現況分類統計表<font color="red">(A4橫式)</font></td>
	</tr>
	<tr>
