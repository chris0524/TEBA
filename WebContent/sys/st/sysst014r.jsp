...
<jsp:useBean id="obj" scope="request" class="sys.st.SYSST014R">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<%
if ("exportAll".equals(obj.getState())) {
	obj.setFilestoreLocation(this.getServletContext().getRealPath("/sys/st/templates/sysst014r.xls"));
	obj.genExcelFile();
...
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">非公用土地清理情形表<font color="red">(A4橫式)</font></td>
	</tr>
	<tr>
