...
<jsp:useBean id="obj" scope="request" class="sys.st.SYSST010R">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<%
if ("exportAll".equals(obj.getState())) {
	obj.setFilestoreLocation(this.getServletContext().getRealPath("/sys/st/templates/sysst010r.xls"));
	obj.genExcelFile();
...
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">非公用不動產使用情形統計表<font color="red">(A4直式)</font></td>
	</tr>
	<tr>
