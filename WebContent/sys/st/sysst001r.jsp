...
<jsp:useBean id="obj" scope="request" class="sys.st.SYSST001R">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<%
if ("exportAll".equals(obj.getState())) {
	obj.setFilestoreLocation(this.getServletContext().getRealPath("/sys/st/templates/sysst001r.xls"));
	obj.genExcelFile();
...
function exportPopup(){
    ...
    window.open(url);
    //var url = "../../home/fileDownload.jsp?fileName=" + form1.excelFileName.value;
    //window.open(url);
    /**
    var moshe;
...
<table class="bg" width="60%" cellspacing="0" cellpadding="0" align="center"><tr><td>
	...
	<tr>
        <td class="td_form" colspan="4" style="text-align:center">市有財產統計圖表<font color="red">(A4橫式)</font></td>
	</tr>
	<tr>
