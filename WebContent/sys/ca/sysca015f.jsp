...
<jsp:useBean id="obj" scope="request" class="sys.ca.SYSCA015F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (sys.ca.SYSCA015F)obj.queryOne();	
...
function checkField(){
	...
	if(form1.state.value=="queryAll"){
		...
		alertStr += checkEmpty(form1.deprUnitNo,"部門別");
		alertStr += checkEmpty(form1.deprAccountsNo,"會計科目");
	}
	if(alertStr.length!=0){ alert(alertStr); return false; }
	beforeSubmit();
}

function queryOne(enterOrg, deprUnitNo, deprAccountsNo){
	form1.enterOrg.value=enterOrg;
	form1.deprUnitNo.value=deprUnitNo;
	form1.deprAccountsNo.value=deprAccountsNo;
...
<!--Query區============================================================-->
<div id="queryContainer" style="width:546px;height:150px;display:none">
	...
	<table class="queryTable"  border="1">
	  ...
	  <tr>
		  ...
		  <td class="queryTDInput">
			<select class="field_Q" type="select" name="q_deprAccountsNo">
			　　<%=util.View.getOption("select deprAccountsNo, deprAccountsName from SYSCA_DEPRACCOUNTS where enterOrg='" + obj.getEnterOrg() + "' order by deprAccountsNo", obj.getQ_deprAccountsNo())%>
			</select>
	      </td>
		</tr>
		<tr>
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form"><font color="red">*</font>會計科目：</td>
		<td class="td_form_white">
			<select class="field_P" type="select" name="deprAccountsNo">
			　　<%=util.View.getOption("select deprAccountsNo, deprAccountsName from SYSCA_DEPRACCOUNTS where enterOrg='" + obj.getEnterOrg() + "' order by deprAccountsNo", obj.getDeprAccountsNo())%>
			</select>
		</td>
	</tr>
	<tr>
		<td class="td_form">備註：</td>
		<td class="td_form_white" colspan="3"><textarea class="field" type="text" name="notes" cols="30" rows="4"><%=obj.getNotes()%></textarea></td>
	</tr>  
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',2,false);" href="#">會計科目</a></th>
	</thead>
	<tbody id="listTBODY">
	<%
