...
<jsp:useBean id="obj" scope="request" class="sys.ca.SYSCA013F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (sys.ca.SYSCA013F)obj.queryOne();	
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',5,false);" href="#">最低使用年限</a></th>
	</thead>
	<tbody id="listTBODY">
	<%
