...
<jsp:useBean id="obj" scope="request" class="sys.pk.SYSPK002F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (sys.pk.SYSPK002F)obj.queryOne();	
...
function queryOne(noticeNo,propertyNo){
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		<td ID=t1 CLASS="tab_border2" HEIGHT="25"><a href="#" onClick="return checkURL('syspk001f.jsp');">行政院函知案件管理</a></td>		
		<td ID=t2 CLASS="tab_border1">行政院函知財產編號</td>
	</tr>
	<tr>
...
<tr><td class="bg">
	...
	<tr>
		<td class="td_form" width="16%">案號：</td>
		<td class="td_form_white">
			[<input class="field_QRO" type="text" name="noticeNo" size="6" maxlength="6" value="<%=obj.getNoticeNo()%>">]		</td>
	...
	<tr>
	  ...
	  <td class="td_form_white">
			<input class="field_P" type="text" name="propertyNo" size="10" maxlength="10" value="<%=obj.getPropertyNo()%>" onBlur="callLookup();" onChange="callLookup();">		</td>
