...
if ("queryAll".equals(obj.getState())) {
	...
	if (("3".equals(user.getRoleid()) || "Y".equals(user.getIsAdminManager())) && obj.doImportProcess(user.getOrganID(), user.getUserID()))
		obj.setErrorMsg("已成功匯入行政院主計處501~503開頭的動產編號！");
}else if ("importNe".equals(obj.getState())) {
	if (("3".equals(user.getRoleid()) || "Y".equals(user.getIsAdminManager())) && obj.doImportNeProcess(user.getOrganID(), user.getUserID()))
...
<div id="queryContainer" style="width:400px;height:130px;display:none">
	...
	<tr>
		...
		<td class="queryTDInput">
			<input class="field_Q" type="text" name="q_propertyNo" size="15" maxlength="12" value="<%=obj.getQ_propertyNo()%>">
		</td>
	</tr>	
	<tr>
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white">
			...
			<tr><td>
				<input class="field_P" type="text" name="propertyNo" size="15" maxlength="12" value="<%=obj.getPropertyNo()%>">
			</td>
			<td align="right" style="display:none;"><%if (obj.getPrefix().equals("'503','504','505'")) {%>
	...
	<tr>
		...
		<td class="queryTDInput">
			<select class="field_Q" type="select" name="propertyType" style="width:150px">
	...
	<tr>
		...
		<td class="td_form_white">
			...
			材質：
			<input class="field" type="text" name="material" size="8" maxlength="20" value="<%=obj.getMaterial()%>">　
		           最低限用年度：
...
<tr><td class="bg" style="text-align:center">
	...
	<input type="hidden" name="q_propertyType" value="<%=obj.getQ_propertyType()%>">
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<!-- <th class="listTH"><a class="text_link_w">選擇</a></th>		 -->	
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',4,false);" href="#">年限</a></th>
	</thead>
	<tbody id="listTBODY">
	<%
