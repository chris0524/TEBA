...
function init() {
	setDisplayItem("spanToolbar,spanListPrint,spanConfirm,spanClear,spanDelete,spanUpdate,spanQueryAll,spanInsert,spanNextInsert,spanListHidden","H");
...
<tr><td class="bg">
	...
	<tr>
		...
		<td class="td_form_white" >
			<input class="field_Q" type="text" name="q_propertyName" size="20" maxlength="50" value="<%=obj.getQ_propertyName()%>"></td>
	</tr>
	<tr>		
		<td class="td_form">&nbsp;<font color="red">*</font>使用年限：</td>
		<td class="td_form_white">
			<input class="field_Q" type="text" name="q_limitYear" size="2" maxlength="2" value="<%=obj.getQ_limitYear()%>">
		</td>		
	</tr>
