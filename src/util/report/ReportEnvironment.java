...
public class ReportEnvironment extends Hashtable{
	...
	static public final String VAL_FORMAT_XML = "XML";
	static public final String VAL_FORMAT_ODT = "ODT"; //openoffice word
	static public final String VAL_FORMAT_ODS = "ODS"; //openoffice excel	
	//static public final String VAL_FORMAT_ODP = "ODP"; //openoffice powerpoint
