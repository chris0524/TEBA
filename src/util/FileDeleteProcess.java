...
public class FileDeleteProcess
{
    ...
    static Hashtable taskTable = new Hashtable();
    ...
    static public void scheduleDeleteFile(File file, long afterms){
        ...
        logger.debug("scheuld delete file:"+file.getAbsolutePath()+" after "+afterms+" ms");
    }
    ...
    static public void scheduleDeleteFile(File file, Date date){
        ...
        logger.debug("scheuld delete file:"+file.getAbsolutePath()+" at "+date);        
    }
    /*
     * 取得下一個整小時時間
     */
    ...
    static class DeleteFileTimerTask extends TimerTask{
        ...
        public void run(){
            ...
            taskTable.remove(targetFile.getAbsoluteFile());
        }
    }
