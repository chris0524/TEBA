...
public class UNTNE035F extends UNTNE024Q{
...
protected String[][] getInsertCheckSQL(){
	...
	ResultSet rs;	
	String sql="select max(TO_NUMBER(serialNo1))+1 as serialNo1 from UNTNE_Attachment2 where 1=1 " +
...
protected String[] getInsertSQL(){
	...
	execSQLArray[0]=" insert into UNTNE_Attachment2(" +
		...
		" )Values(" +
			...
			Common.sqlChar(this.getBuyDate()) + "," +
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0]=" update UNTNE_Attachment2 set " +
			...
			" buyDate = " + Common.sqlChar(this.getBuyDate()) + "," +
...
public UNTNE035F  queryOne() throws Exception{
	Database db = new Database();
	UNTNE035F obj = this;
	try {
