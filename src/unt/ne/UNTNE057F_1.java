...
public class UNTNE057F_1 extends SuperBean2{
	...
	public ArrayList queryAll() throws Exception{
		...
		String sql = "select * from (" +				
					...
					" select " +
							...
							"'增減值單' as prooftype," +
							"(select proofYear + '年' + proofDoc + '字第' + proofNo + '號' from UNTNE_ADJUSTPROOF z where z.enterorg = a.enterorg and z.ownership = a.ownership and z.differencekind = a.differencekind and z.caseno = a.caseno) as proofData," +
					...
					" select " +
							...
							"'減損單' as prooftype," +
							"(select proofYear + '年' + proofDoc + '字第' + proofNo + '號' from UNTNE_REDUCEPROOF z where z.enterorg = a.enterorg and z.ownership = a.ownership and z.differencekind = a.differencekind and z.caseno = a.caseno) as proofData," +
							"null as originalNote," +
					...
					" select " +
							...
							"'廢品處理單' as prooftype," +
							"(select proofYear + '年' + proofDoc + '字第' + proofNo + '號' from UNTNE_DEALPROOF z where z.enterorg = a.enterorg and 1 = a.ownership and z.differencekind = a.differencekind and z.caseno1 = a.caseno1) as proofData," +
							"null as originalNote," +
							"0 as oldNetValue," +
							"0 as addNetValue," +
							"0 as reducebookvalue," +
							"0 as newNetValue" +
						" from UNTNE_DEALDETAIL a where 1=1" +
						condition() +	
