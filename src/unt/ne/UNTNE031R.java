...
public class UNTNE031R extends SuperBean{
	String q_enterOrg;
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	String[] columns = new String[] {"ENTERORGNAME","OWNERSHIP","REDUCEDATE1","KEEPER","PROPERTYNO","PROPERTYNAME","SPECIFICATION","LIMITYEAR","USEYEAR","PROPERTYUNIT","BOOKAMOUNT","BOOKVALUE1","BOOKVALUE","ENTERDATE","BUYDATE","USEUNIT","USENAME","PERMITREDUCEDATE"};
    	...
    	String execSQL="select c.organAName as enterOrgName," +
    			...
    			" a.permitReduceDate  ";
    	execSQL += " from UNTNE_Nonexp a,UNTNE_NonexpDetail b,SYSCA_Organ c,SYSPK_PropertyCode2 d ";
    	execSQL += " where a.enterorg=b.enterorg and  a.ownership=b.ownership and  b.propertyNo=a.propertyNo and a.lotNo=b.lotNo and b.enterOrg=d.enterOrg and b.propertyNo=d.propertyNo and a.enterOrg=c.organID(+)";
        ...
        while(rs.next()){
        	...
        	DateTrn = rs.getString("permitReduceDate");
        	if(DateTrn!=null)data[17]=DateTrn.substring(0,3)+"/"+DateTrn.substring(3,5)+"/"+DateTrn.substring(5,7);
        	else data[17]=null;
