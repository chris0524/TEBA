...
public class UNTNE037R extends SuperBean{
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	...
    	String[] columns = new String[] {"OWNERSHIP","ENTERORGNAME","CASENO","PROPERTYNO","PROPERTYNAME","SPECIFICATION","BUYDATE","LIMITYEAR","USEYEAR","PROPERTYUNIT","ADJUSTBOOKAMOUNT","OLDBOOKUNIT","ADJUSTBOOKVALUE","CAUSE2","SIGN"};
    	String execSQL="select c.organAName as enterOrgName," +
		    			...
		    			" d.propertyName," +
		    			" b.nameplate||b.specification as specification," +
		    			" b.buyDate," +
    	...
    	execSQL1=execSQL1+"where a.enterorg=b.enterorg and a.caseno=b.caseno and a.ownership=b.ownership and b.enterOrg=d.enterOrg and b.propertyNo=d.propertyNo and a.enterOrg=c.organID(+) ";
