...
public class UNTVP008F extends UNTVP006Q{
String enterOrg;
String enterOrgName;
String ownership;
String caseNo;
...
public String getOldProofS(){ return checkGet(oldProofS); }
public void setOldProofS(String s){ oldProofS=checkSet(s); }
public String getOldProofE(){ return checkGet(oldProofE); }
public void setOldProofE(String s){ oldProofE=checkSet(s); }
...
protected String[][] getInsertCheckSQL(){
	...
	String sql="select nvl(sum(adjustBookAmount),0) as adjustBookAmount1, nvl(sum(adjustBookValue),0) as adjustBookValue1 from UNTVP_AdjustDetail " +
	...
	sql="select nvl(sum(adjustBookAmount),0) as adjustBookAmount2, nvl(sum(adjustBookValue),0) as adjustBookValue2 from UNTVP_AdjustDetail " +
	...
	try {		
		rs = db.querySQL(sql);
		if (rs.next()){
		    //setAdjustBookSheet2(Integer.parseInt(rs.getString("adjustBookSheet2"))+Integer.parseInt(adjustBookSheet)+"");
		    setAdjustBookAmount2(Long.parseLong(rs.getString("adjustBookAmount2"))+Long.parseLong(adjustBookAmount)+"");
		    setAdjustBookValue2(Long.parseLong(rs.getString("adjustBookValue2"))+Long.parseLong(adjustBookValue)+"");
		} else {
	...
	sql="select nvl(oldBookAmount,0) as oldBookAmount, nvl(oldBookValue,0) as oldBookValue from UNTVP_AdjustProof " +
		" where 1=1 " +
		" and enterOrg = " + Common.sqlChar(enterOrg) + 
		" and ownership = " + Common.sqlChar(ownership) + 
		" and caseNo = " + Common.sqlChar(caseNo) +
...
protected String[] getInsertSQL(){
	...
	execSQLArray[0]=" insert into UNTVP_AdjustDetail(" +
		...
		" )Values(" +
			...
			Common.sqlChar(oldProofS) + "," +
			Common.sqlChar(oldProofE) + "," +
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0]=" update UNTVP_AdjustDetail set " +
			...
			" oldProofS = " + Common.sqlChar(oldProofS) + "," +
			" oldProofE = " + Common.sqlChar(oldProofE) + "," +
...
public UNTVP008F  queryOne() throws Exception{
	Database db = new Database();
	UNTVP008F obj = this;
	try {
		String sql=" select a.enterOrg, a.ownership, a.caseNo, a.propertyNo, a.serialNo, a.adjustType, a.serialNo1, a.oldBookAmount, a.oldBookUV, a.oldBookValue, decode(a.oldProofS,'',' ',a.oldProofS) as oldProofS, decode(a.oldProofE,'',' ',a.oldProofE) as oldProofE, a.adjustBookUA, a.adjustBookSheet, a.adjustBookAmount, a.adjustBookUV, a.adjustBookValue, a.adjustProofS, a.adjustProofE, a.newBookUA, a.newBookSheet, a.newBookAmount, a.newBookUV, a.newBookValue, decode(a.newProofS,'',' ',a.newProofS) as newProofS, decode(a.newProofE,'',' ',a.newProofE) as newProofE, a.Notes, a.editID, a.editDate, a.editTime, " +
					" oldSerialNo1 "+
		...
		if (rs.next()){
			...
			obj.setOldProofS(rs.getString("oldProofS"));
			obj.setOldProofE(rs.getString("oldProofE"));
...
public ArrayList queryAll() throws Exception{
	...
	try {
		String sql=" select a.enterOrg, a.ownership, a.caseNo, a.propertyNo, a.serialNo, a.serialNo1, a.adjustBookUA, a.adjustBookSheet, a.adjustBookAmount, a.adjustBookUV, a.adjustBookValue, b.verify "+
			" from UNTVP_AdjustDetail a, UNTVP_AdjustProof b where 1=1 and a.adjustType = '2' "+ 
