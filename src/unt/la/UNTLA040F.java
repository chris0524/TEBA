...
public class UNTLA040F extends SuperBean{
...
protected String[][] getInsertCheckSQL(){
	String[][] checkSQLArray = new String[1][4];
 	checkSQLArray[0][0]=" select count(*) as checkResult from UNTLA_DRAWPROOF where 1=1 " + 
...
protected String[] getInsertSQL(){
	...
	ResultSet rs;	
	String sql="select max(serialNo1)+1 as serialNo1 from UNTLA_DRAWPROOF " +
	...
	execSQLArray[0]=" insert into UNTLA_DRAWPROOF(" +
			" enterOrg,"+
			" ownership,"+
			" propertyNo,"+
			//" signNo,"+
...
protected String[] getUpdateSQL(){
	String[] execSQLArray = new String[1];
	execSQLArray[0]=" update UNTLA_DRAWPROOF set " +
...
protected String[] getDeleteSQL(){
	String[] execSQLArray = new String[1];
	execSQLArray[0]=" delete UNTLA_DRAWPROOF where 1=1 " +
			" and enterOrg = " + Common.sqlChar(enterOrg) +
			" and ownership = " + Common.sqlChar(ownership) +
			" and propertyNo = " + Common.sqlChar(propertyNo) +
			" and serialNo = " + Common.sqlChar(serialNo) +
...
public UNTLA040F  queryOne() throws Exception{
	Database db = new Database();
	UNTLA040F obj = this;
	try {
		String sql=" select a.enterOrg, e.organsname, a.ownership, a.propertyNo, b.propertyName, d.signNo "+
			", d.ownershipDate, d.proofDoc, a.serialNo, a.serialNo1, a.drawDate, a.drawName, a.drawCause, a.drawCause1 " + 
			", a.returnDate, a.notes, a.oldPropertyNo, a.oldSerialNo, a.editID, a.editDate, a.editTime "+
			", d.dataState, case when d.dataState='2' then '已減損' else '現存' end as dataStateName " +
			" from UNTLA_DRAWPROOF a, SYSPK_PropertyCode b, UNTLA_LAND d, SYSCA_ORGAN e where 1=1 " +			
...
public ArrayList queryAll() throws Exception{
	...
	try {
		String sql=" select a.enterOrg, a.ownership, case when a.ownership='1' then '市有' else '國有' end as ownershipName, a.propertyNo, b.propertyName, e.signNo, a.serialNo, a.serialNo1, a.drawDate, a.drawName "+
			...
			" from UNTLA_DRAWPROOF a, SYSPK_PropertyCode b, SYSCA_CODE d, UNTLA_LAND e where 1=1 "+
		...
		while (rs.next()){
			...
			rowArray[2]=getSignDescName(rs.getString("signNo").substring(0,7)) + rs.getString("signNo").substring(7,11) + '-' + rs.getString("signNo").substring(11);
