...
public class UNTLA037F extends UNTLA027Q{
...
public String getOwnership_1(){ return checkGet(ownership_1); }
public void setOwnership_1(String s){ ownership_1=checkSet(s); }
...
public UNTLA037F  queryOne() throws Exception{
	Database db = new Database();
	UNTLA037F obj = this;
	try {
		String sql=" select b.organSName,a.enterOrg, a.ownership, a.caseNo, " +
			...
			" a.fundType, a.valuable, a.taxCredit, a.originalArea, " +
			...
			" a.manageOrg, a.useState, a.useState1, a.proceedDateS, a.proceedDateE, a.proceedType, " +
...
//System.out.println(sql);		
		...
		if (rs.next()){
			...
			obj.setUseState(rs.getString("useState1"));
...
//System.out.println("queryAll==>"+sql);
		...
		while (rs.next()){
			...
			rowArray[6]=rs.getString("signNoName"); 
