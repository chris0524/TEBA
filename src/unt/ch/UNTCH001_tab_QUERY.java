...
import unt.ch.untch001f00.UNTCH001F00_BU_ADD_QUERY;
import unt.ch.untch001f00.UNTCH001F00_Base;
import unt.ch.untch001f00.UNTCH001F00_CH_ADD_QUERY;
import unt.ch.untch001f00.UNTCH001F00_CH_ADJUST;
import unt.ch.untch001f00.UNTCH001F00_CH_MOVE;
import unt.ch.untch001f00.UNTCH001F00_CH_REDUCE;
import unt.ch.untch001f00.UNTCH001F00_LA_ADD_QUERY;
import unt.ch.untch001f00.UNTCH001F00_MP_ADD_QUERY;
import unt.ch.untch001f00.UNTCH001F00_MP_DEAL;
import unt.ch.untch001f00.UNTCH001F00_MP_MOVE;
import unt.ch.untch001f00.UNTCH001F00_RF_ADD_QUERY;
import unt.ch.untch001f00.UNTCH001F00_RT_ADD_QUERY;
import unt.ch.untch001f00.UNTCH001F00_RT_ADJUST;
import unt.ch.untch001f00.UNTCH001F00_RT_REDUCE;
import unt.ch.untch001f00.UNTCH001F00_VP_ADD_QUERY;
import unt.ch.untch001f00.UNTCH001F00_VP_ADJUST;

public class UNTCH001_tab_QUERY{
	...
	public String _createTabData(String type, int i){		return doCreateTabDate(type, i);}
			...
			private UNTCH001F00_Base doCheckWhichPropertyType(String type){
				...
				if(_CH_ADD.equals(type)){				UNTCH001F00_CH_ADD_QUERY ch = new UNTCH001F00_CH_ADD_QUERY();
				...
				}else if(_LA_ADD.equals(type)){			UNTCH001F00_LA_ADD_QUERY ch = new UNTCH001F00_LA_ADD_QUERY();
														ch._setupViewType(viewType);
														result = ch;
				
				}else if(_BU_ADD.equals(type)){			UNTCH001F00_BU_ADD_QUERY ch = new UNTCH001F00_BU_ADD_QUERY();
														ch._setupViewType(viewType);
														result = ch;
				
				}else if(_RF_ADD.equals(type)){			UNTCH001F00_RF_ADD_QUERY ch = new UNTCH001F00_RF_ADD_QUERY();
														ch._setupViewType(viewType);
														result = ch;
				
				}else if(_MP_ADD.equals(type)){			UNTCH001F00_MP_ADD_QUERY ch = new UNTCH001F00_MP_ADD_QUERY();
														ch._setupViewType(viewType);
														result = ch;
				...
				}else if(_VP_ADD.equals(type)){			UNTCH001F00_VP_ADD_QUERY ch = new UNTCH001F00_VP_ADD_QUERY();
														ch._setupViewType(viewType);
														result = ch;
														
				}else if(_VP_ADJUST.equals(type)){		result = new UNTCH001F00_VP_ADJUST();
				
				}else if(_RT_ADD.equals(type)){			UNTCH001F00_RT_ADD_QUERY ch = new UNTCH001F00_RT_ADD_QUERY();
														ch._setupViewType(viewType);
														result = ch;
