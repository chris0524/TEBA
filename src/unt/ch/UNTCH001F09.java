...
public class UNTCH001F09 extends UNTCH001Q {
	...
	public UNTCH001F09 _execQueryOneforDetail(){
		...
		try{
			...
			this.setPropertyNoName(ul._getPropertyNoName(this.getPropertyNo()));
...
//								" and a.caseno = z.caseno").append(
					...
					" union ").append(
						" select").append(	
							...
							") a").append(
							" order by datastate,propertyno, serialNo");
			...
			if (getTotalRecord() > 0) {
				...
				do {
					...
					rowArray[5] = uctls._getDifferenceKindName(rs.getString("differenceKind"));
...
//						rowArray[8] =  serialNo +"-"+ serialNoE;
//					}else{
//						if("MP".equals(checkGet(rs.getString("type")))){
//							rowArray[8] = serialNoE;
//						}else{
//							rowArray[8] = serialNo;
//						}
//					}
					rowArray[9] = checkGet(rs.getString("lotNo"));
					rowArray[10] = uctls._getPropertyNoName(rs.getString("propertyNo"));
					rowArray[11] = checkGet(uctls._transToROC_Year(rs.getString("sourceDate")));
					...
					String nameplate = checkGet(rs.getString("nameplate"));
					
					if("".equals(checkGet(signNoLa)) || signNoLa.length() < 15){				
					}else{
						rowArray[12] = uctls._getSignNoName(signNoLa.substring(0,7)) + signNoLa.substring(7,11) + "-" + signNoLa.substring(11) + "地號";
					}
					if("".equals(checkGet(signNoBu)) || signNoBu.length() < 15){				
					}else{					
						rowArray[12] = uctls._getSignNoName(signNoBu.substring(0,7)) + signNoBu.substring(7,12) + "-" + signNoBu.substring(12) + "建號";
					}
					if("".equals(checkGet(specification)) && "".equals(checkGet(nameplate))){				
					}else{
						rowArray[12] = specification + "/" + nameplate;
					}
					
					rowArray[13] = st._getMoneyFormat(rs.getString("bookValue"));
					rowArray[14] = Common.get(rs.getString("limityear"));
					rowArray[15] = uctls._getDataStateName(rs.getString("datastate"));				
					rowArray[16] = uctls._getOrganSName(rs.getString("enterOrg"));
		...
		private String getQueryCondition(String table){
			...
			if("detail".equals(getQuerySelect())){
				...
				if("untch001f02extend01".equals(getProgID())){
					...
					if (!"".equals(getOwnership())) {
						result += " and a.ownership = " + Common.sqlChar(getOwnership());
					}
					if (!"".equals(getCaseNo())) {
						result += " and a.caseNo = " + Common.sqlChar(getCaseNo());
					}
					if (!"".equals(getDifferenceKind())) {
						result += " and a.differenceKind = " + Common.sqlChar(getDifferenceKind());
					}
				}
			...
			if (!"".equals(getQ_enterOrg())) {
				result += " and a.enterOrg = " + Common.sqlChar(getQ_enterOrg());
			}
			if (!"".equals(getQ_ownership())) {
				result += " and a.ownership = " + Common.sqlChar(getQ_ownership());
			}
			if (!"".equals(getQ_caseNoS())) {
				result += " and a.caseNo >= " + Common.sqlChar(getQ_caseNoS());
			}
			if (!"".equals(getQ_caseNoE())) {
				result += " and a.caseNo <= " + Common.sqlChar(getQ_caseNoE());
			}			
			...
			if (!"".equals(getQ_differenceKind_detail())) {
				result += " and a.differenceKind = " + Common.sqlChar(getQ_differenceKind_detail());
			}
			...
			if (!"".equals(getQ_serialNoS())){
				if("MP".equals(table)){
					result += " and z.serialNo >= " + Common.sqlChar(getQ_serialNoS());
				}else{
			...
			if (!"".equals(getQ_serialNoE())){
				if("MP".equals(table)){
					result += " and z.serialNo <= " + Common.sqlChar(getQ_serialNoE());
				}else{
			...
			if (!"".equals(getQ_sourceKind())) {
				result += " and a.sourceKind = " + Common.sqlChar(getQ_sourceKind());
			}
			
			if (!"".equals(getQ_oldPropertyNoS())){
				result += " and a.oldpropertyNo >= " + Common.sqlChar(getQ_oldPropertyNoS());
			}
			if (!"".equals(getQ_oldPropertyNoE())){
				result += " and a.oldpropertyNo <= " + Common.sqlChar(getQ_oldPropertyNoE());
			}
			if (!"".equals(getQ_oldSerialNoS())){
				if("MP".equals(table)){
					result += " and z.oldSerialNo >= " + Common.sqlChar(getQ_oldSerialNoS());
				}else{
					result += " and a.oldSerialNo >= " + Common.sqlChar(getQ_oldSerialNoS());	
				}				
			}
			if (!"".equals(getQ_oldSerialNoE())){
				if("MP".equals(table)){
					result += " and z.oldSerialNo <= " + Common.sqlChar(getQ_oldSerialNoE());
				}else{
					result += " and a.oldSerialNo <= " + Common.sqlChar(getQ_oldSerialNoE());	
				}
				
			}
			if (!"".equals(getQ_oldlotNoS())){
				result += " and a.oldlotNo >= " + Common.sqlChar(getQ_oldlotNoS());
			}
			if (!"".equals(getQ_oldlotNoE())){
				result += " and a.oldlotNo <= " + Common.sqlChar(getQ_oldlotNoE());	
			}
			if (!"".equals(getQ_propertyKind())){
				result += " and a.propertyKind = " + Common.sqlChar(getQ_propertyKind());
			}
			if (!"".equals(getQ_valuable())){
				if(!"BU".equals(table) && !"VP".equals(table) && !"RT".equals(table) ){
			...
			if (!"".equals(getQ_taxCredit())){
				if(!"MP".equals(table) && !"VP".equals(table) && !"RT".equals(table) ){
					result += " and a.taxCredit = " + Common.sqlChar(getQ_taxCredit());
				}
			}
			if (!"".equals(getQ_cause())){
				result += " and a.cause = " + Common.sqlChar(getQ_cause());
			}
			if (!"".equals(getQ_propertyName1())){
				result += " and a.propertyName1 like " + Common.sqlChar("%" + getQ_propertyName1() + "%");
			}
			
			if (!"".equals(getQ_enterDateS())){
				result += " and a.enterDate >= " + Common.sqlChar(new Datetime().changeTaiwanYYMMDD(getQ_enterDateS(),"2"));
			}
			if (!"".equals(getQ_enterDateE())){
				result += " and a.enterDate <= " + Common.sqlChar(new Datetime().changeTaiwanYYMMDD(getQ_enterDateE(),"2"));
			}
			
			if (!"".equals(getQ_sourceDateS())){
				result += " and a.sourceDate >= " + Common.sqlChar(new Datetime().changeTaiwanYYMMDD(getQ_sourceDateS(),"2"));
			}
			if (!"".equals(getQ_sourceDateE())){
				result += " and a.sourceDate <= " + Common.sqlChar(new Datetime().changeTaiwanYYMMDD(getQ_sourceDateE(),"2"));
			}
			
			if (!"".equals(getQ_keepUnit())){
				if("MP".equals(table)){
					result += " and z.keepUnit = " + Common.sqlChar(getQ_keepUnit());
				}else{
			...
			if (!"".equals(getQ_keeper())){
				if("MP".equals(table)){
					result += " and z.keeper = " + Common.sqlChar(getQ_keeper());
				}else{
			...
			if (!"".equals(getQ_useUnit())){
				if("MP".equals(table)){
					result += " and z.useUnit = " + Common.sqlChar(getQ_useUnit());
				}else{
			...
			if (!"".equals(getQ_userNo())){
				if("MP".equals(table)){
					result += " and z.userNo = " + Common.sqlChar(getQ_userNo());
				}else{
			...
			if (!"".equals(getQ_originalUserNote())){
				if("MP".equals(table)){
					result += " and z.originalUserNote like " + Common.sqlChar("%" + getQ_originalUserNote() + "%");
				}else{
					result += " and a.originalUserNote like " + Common.sqlChar("%" + getQ_originalUserNote() + "%");
				}
			}
			if (!"".equals(getQ_doorPlate4())){
				if("BU".equals(table)){
					result += " and a.doorPlate4 = " + Common.sqlChar(getQ_doorPlate4());
				}
			}
			if (!"".equals(getQ_place1())){
				if("MP".equals(table)){
					result += " and z.place1 = " + Common.sqlChar(getQ_place());
				}else{
			...
			if (!"".equals(getQ_place())){
				if("MP".equals(table)){
					result += " and z.place like " + Common.sqlChar("%" + getQ_place() + "%");
				}else{
			...
			if (!"".equals(getQ_dataState())){
				if("MP".equals(table)){
					result += " and a.dataState = " + Common.sqlChar(getQ_dataState());
				}else{
					result += " and a.dataState = " + Common.sqlChar(getQ_dataState());
				}
			}
			...
			if ("Y".equals(getQ_originalBuildFeeCB())){
				if(!"LA".equals(table) && !"VP".equals(table) && !"RT".equals(table) ){
					result += " and a.originalBuildFeeCB = " + Common.sqlChar(getQ_originalBuildFeeCB());
				}else{
					result += " and 1 != 1";
				}
			}
			if ("Y".equals(getQ_originalDeprUnitCB())){
				if(!"LA".equals(table) && !"VP".equals(table) && !"RT".equals(table) ){
					result += " and a.originalDeprUnitCB = " + Common.sqlChar(getQ_originalDeprUnitCB());
				}else{
					result += " and 1 != 1";
				}
			}
			if (!"".equals(getQ_otherlimityear())){
				if("MP".equals(table)){
					result += " and z.otherlimityear/12 = " + Common.sqlChar(getQ_otherlimityear());
				} else if("BU".equals(table) || "RF".equals(table)){
					result += " and a.otherlimityear/12 = " + Common.sqlChar(getQ_otherlimityear());
				}
			}
			...
			if (!"".equals(q_signLaNo) || !"".equals(q_signBuNo)){
				if (!"".equals(q_signLaNo) && "LA".equals(table)){
					...
					if (!"".equals(getQ_signLaNo4S())){
						result += " and substring(signno,8,8) >= '" + getQ_signLaNo4S() + getQ_signLaNo5S() + "'";				
					}	
					if (!"".equals(getQ_signLaNo4E())){
						result += " and substring(signno,8,8) <= '" + getQ_signLaNo4E() + getQ_signLaNo5E() + "'";				
					}
					...
					if (!"".equals(getQ_signBuNo4S())){
						result += " and substring(signno,8,8) >= '" + getQ_signBuNo4S() + getQ_signBuNo5S() + "'";				
					}	
					if (!"".equals(getQ_signBuNo4E())){
						result += " and substring(signno,8,8) <= '" + getQ_signBuNo4E() + getQ_signBuNo5E() + "'";				
					}					
			...
			if ("1".equals(this.getRoleid())){
				if("MP".equals(table)){
					result += " and z.keeper = " + Common.sqlChar(this.getKeeperno());
				}else{
					result += " and a.keeper = " + Common.sqlChar(this.getKeeperno());
				}
				
				
			}else if ("2".equals(this.getRoleid())){
				if("MP".equals(table)){
					result += " and z.keepunit = " + Common.sqlChar(this.getUnitID());
				}else{
					result += " and a.keepunit = " + Common.sqlChar(this.getUnitID());
				}
			...
			if("untch001f02extend01".equals(this.getProgID()) || "untch001f02extend02".equals(this.getProgID())){
				result += " and a.verify = 'Y'";
			} else {
				if (!"".equals(this.getQ_verify())) {
					result += " and a.verify = " + Common.sqlChar(this.getQ_verify());
				}
			}
