...
public class UNTTE002R extends SuperBean{
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	String[] columns = new String[] {"SIGNNO","DATE","TAXKINDTYPE","TAXAMOUNT","TAXKIND"};
    	String todayDate = Integer.parseInt(Datetime.getYYY())+"年"+Datetime.getMM()+"月"+Datetime.getYYYMMDD().substring(5,7)+"日";
    	//土地
		...
		for(int j=0; j<countSumTotal; j++){
        	...
        	data[0] = signNoSum[j];
    	    data[1] = todayDate;
    	    data[2] = "繳納補徵"+Integer.parseInt(Datetime.getYYY())+"年至"+Integer.parseInt(Datetime.getYYY())+"年"+taxKindType;
    	    data[3] = "新台幣"+Common.numToZh(new java.math.BigDecimal(taxAmountSum[j]));
    	    data[4] = "限繳"+taxKindType;
