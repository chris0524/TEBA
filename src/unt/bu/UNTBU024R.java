...
public class UNTBU024R extends SuperBean{
	String enterOrg;
	String ownership;
	String caseNoS;
	String caseNoE;
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	...
    	String[] columns = new String[] {"ENTERORGNAME","WRITEDATE","WRITEUNIT","PROOFNO","CASENO"
    									,"MANAGENO","SOURCEDATE","PROPERTYNO","PROPERTYNAME","SIGNNO"
    									,"CAUSE","OLDHOLDAREA","OLDBOOKVALUE","ADJUSTHOLDAREA1"
    									,"ADJUSTBOOKVALUE1","ADJUSTHOLDAREA2","ADJUSTBOOKVALUE2"
    									,"NEWHOLDAREA","NEWBOOKVALUE","KIND","UNIT","summonsNo"
    									,"propertyKind","propertyKindName","ownershipTitle"
    									};
    	...
    	String execSQL = " select c.organAName as enterOrgName ,a.writeDate ,a.writeUnit " + "\n"  
    				   ...
    				   + " 		 ,d.propertyName " + "\n"  
    				   + " 		 ,b.cause ,b.cause1 ,b.oldHoldArea ,b.oldBookValue ,b.adjustType " + "\n"  
    				   + " 		 ,b.adjustHoldArea , b.adjustBookValue ,b.newHoldArea ,b.newBookValue " + "\n"  
    				   + " 		 ,d.propertyUnit , a.summonsNo " + "\n"  
    				   ...
    				   + " 		 from UNTBU_AdjustProof a ,UNTBU_AdjustDetail b ,SYSCA_Organ c ,SYSPK_PropertyCode d " + "\n"  
    				   + " 		 where 1=1 " + "\n"  
    	...
    	if("4".equals(q_kind)){
    		...
    		while(rs.next()){
                ...
                data[9] = getSignDescName(rs.getString("signNo").substring(0,7)) + rs.getString("signNo").substring(7,12) + '-' + rs.getString("signNo").substring(12);
                if("".equals(data[9]))data[9]="";
                ...
                data[11]= new Double(Double.parseDouble(rs.getString("oldHoldArea")));
                ...
                if(tansToDouble!=null){
                	...
                	if("2".equals(AdjustType)){
                		data[15]=new Double(Double.parseDouble(rs.getString("adjustHoldArea")));                		                	 
                		data[13]= new Double(0); 
                	}else {
                	    data[13]=new Double(Double.parseDouble(rs.getString("adjustHoldArea")));                        	    
                	    data[15]= new Double(0); 
                	}
                }else {
                	data[13]=null;
                	data[15]=null;                	
                ...
                if(tansToDouble!=null){
                	Doubletemp= Double.parseDouble(tansToDouble);
                	if("2".equals(AdjustType)){
                		data[16]=new Double(Doubletemp);                
                		data[14]=new Double(0);                
                    }else {
                    	data[14]=new Double(Doubletemp);                
                    	data[16]=new Double(0);                  
                    }
                }else {
                	data[14]=null;
                	data[16]=null;
                ...
                data[17]= new Double(Double.parseDouble(rs.getString("newHoldArea")));
