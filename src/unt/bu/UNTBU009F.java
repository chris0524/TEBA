...
public class UNTBU009F extends UNTBU001Q{
...
protected String[][] getInsertCheckSQL(){
	...
	ResultSet rs;	
	String sql="select max(serialNo1)+1 as serialNo1 from UNTBU_ViewScene " +
	...
	String[][] checkSQLArray = new String[1][4];
 	checkSQLArray[0][0]=" select count(*) as checkResult from UNTBU_ViewScene where 1=1 " + 
...
protected String[] getInsertSQL(){
	...
	execSQLArray[0]=" insert into UNTBU_ViewScene(" +
			" enterOrg,"+
			" ownership,"+
			" propertyNo,"+
			" serialNo,"+
...
protected String[] getUpdateSQL(){
	String[] execSQLArray = new String[1];
	execSQLArray[0]=" update UNTBU_ViewScene set " +
...
protected String[] getDeleteSQL(){
	String[] execSQLArray = new String[1];
	execSQLArray[0]=" delete UNTBU_ViewScene where 1=1 " +
			" and enterOrg = " + Common.sqlChar(enterOrg) +
			" and ownership = " + Common.sqlChar(ownership) +
			" and propertyNo = " + Common.sqlChar(propertyNo) +
			" and serialNo = " + Common.sqlChar(serialNo) +
...
public UNTBU009F  queryOne() throws Exception{
	Database db = new Database();
	UNTBU009F obj = this;
	try {
		String sql=" select a.enterOrg, a.ownership, a.propertyNo, a.serialNo, a.serialNo1, a.viewDescribe, a.viewDate, a.viewPicture, a.viewPicture1, a.viewPicture2, a.notes, a.editID, a.editDate, a.editTime  "+
			" from UNTBU_ViewScene a where 1=1 " +
