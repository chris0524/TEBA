...
public class UNTBU008F extends UNTBU001Q{
...
protected String[][] getInsertCheckSQL(){
	...
	ResultSet rs;	
	String sql="select max(serialNo1)+1 as serialNo1 from UNTBU_Attachment2 " +
	...
	String[][] checkSQLArray = new String[1][4];
 	checkSQLArray[0][0]=" select count(*) as checkResult from UNTBU_Attachment2 where 1=1 " + 
...
protected String[] getInsertSQL(){
	...
	execSQLArray[0]=" insert into UNTBU_Attachment2(" +
			" enterOrg,"+
			" ownership,"+
			" propertyNo,"+
			" serialNo,"+
...
protected String[] getUpdateSQL(){
	String[] execSQLArray = new String[1];
	execSQLArray[0]=" update UNTBU_Attachment2 set " +
...
protected String[] getDeleteSQL(){
	String[] execSQLArray = new String[1];
	execSQLArray[0]=" delete UNTBU_Attachment2 where 1=1 " +
			" and enterOrg = " + Common.sqlChar(enterOrg) +
			" and ownership = " + Common.sqlChar(ownership) +
			" and propertyNo = " + Common.sqlChar(propertyNo) +
			" and serialNo = " + Common.sqlChar(serialNo) +
...
public UNTBU008F  queryOne() throws Exception{
	Database db = new Database();
	UNTBU008F obj = this;
	try {
		String sql=" select a.enterOrg, a.ownership, a.propertyNo, a.serialNo, a.serialNo1, a.equipmentName, a.buyDate, a.equipmentUnit, a.equipmentAmount, a.unitPrice, a.totalValue, a.notes, a.editID, a.editDate, a.editTime  "+
			" from UNTBU_Attachment2 a where 1=1 " +
