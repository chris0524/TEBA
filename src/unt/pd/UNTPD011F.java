...
public class UNTPD011F extends SuperBean{
String enterOrg;
String enterOrgName;
...
public void upPdresult_Date(){
	...
	try{
		updatesql[0] = " update untmp_movabledetail m set " + "\n"
		   			 + " m.checkdates = " + Common.sqlChar(checkDateS) + "\n"
		   			 + " ,m.checkdatee = " + Common.sqlChar(checkDateE) + "\n"
		   			 + " where 1=1 " + "\n"
		   			 + " and exists(select p.barcode from untpd_checkmovable p " + "\n"
		...
		updatesql[1] = " update untmp_movabledetail m set " + "\n"
			   		 + " m.checkresult = '1' " + "\n"
			   		 + " where 1=1 " + "\n"
			   		 + " and exists(select p.barcode from untpd_checkmovable p " + "\n"
			   		 + " where 1=1 and p.enterorg=m.enterorg " + "\n"
		...
		updatesql[2] = " update untmp_movabledetail m set " + "\n"
  		 			 + " m.checkresult = '2' " + "\n"
  		 			 + " where 1=1 " + "\n"
  		 			 + " and exists(select p.barcode from untpd_checkmovable p " + "\n"
  		 			 + " where 1=1 and p.enterorg=m.enterorg " + "\n"
...
public void upDataPdoddscause(){
	String sql = " select p.enterorg ,p.barcode ,p.oddscause from untpd_checkmovable p " + "\n"
			   + " where 1=1 " + "\n"
...
}//public class UNTPD011F extends QueryBean
