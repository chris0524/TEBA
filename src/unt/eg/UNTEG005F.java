...
public class UNTEG005F extends UNTEG001Q{
	...
	public ArrayList queryAll() throws Exception{
		...
		try {
			...
			String sql = "select * from (" +
							eg.getQuerySQL_forUNTLA_ADJUSTDETAIL() +
							" union " +
							eg.getQuerySQL_forUNTBU_ADJUSTDETAIL() +
							" union " +
							eg.getQuerySQL_forUNTRF_ADJUSTDETAIL() +
							" union " +
							eg.getQuerySQL_forUNTMP_ADJUSTDETAIL() +
							" union " +
							eg.getQuerySQL_forUNTVP_ADJUSTPROOF() +
							" union " +
							eg.getQuerySQL_forUNTRT_ADJUSTPROOF() +						
							") a";
