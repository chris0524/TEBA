...
public class UNTMP047R extends SuperBean{
//變數區
String q_enterOrg;
...
public DefaultTableModel getResultModel() throws Exception{
	...
	xlsSql = " select b.enterorg ,c.organaname "
		   + " ,b.ownership ,decode(b.ownership,'1','市有','2','國有','3','KOC') as ownershipName " + "\n" 
		   + " ,b.caseno ,a.writedate " + "\n" 
		   + " ,b.propertyno ,substr(b.propertyno,1,7)||'-'||substr(b.propertyno,8) as propertyno1 ,b.serialno " + "\n" 
		   + " ,d.propertyname ,d.propertyunit ,d.limityear " + "\n" 
		   + " ,b.bookamount ,b.oldbookvalue ,b.adjustbookvalue " + "\n" 
		   + " ,b.sourcedate" + "\n" 
		   + " ,b.cause " + "\n" 
		   + " from UNTMP_AdjustProof a ,UNTMP_AdjustDetail b ,sysca_organ c " + "\n" 
    ...
    try{
    	String[] columns = new String[] {"enterOrgName","ownership","caseno","pagno","writeDate"
    									,"propertyno","proptertynoName","propertyUnit","buydate","limitYear"
    									,"useYear","cause","cause1","oldBookValue","adjustBookValue"
    									,"bookAmount"};
