...
public class UNTMP033R extends SuperBean{
	String q_enterOrg;
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	...
    	execSQL+=" from UNTMP_ReduceProof a,UNTMP_ReduceDetail b,SYSCA_Organ c,SYSPK_PropertyCode d ";
    	execSQL+=" where a.enterorg=b.enterorg and  a.ownership=b.ownership and a.caseno=b.caseno and b.propertyNo=d.propertyNo and a.enterOrg=c.organID(+)";
    	execSQL=execSQL+" and d.enterOrg in ('000000000A',a.enterOrg) ";
