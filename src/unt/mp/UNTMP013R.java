...
public class UNTMP013R extends SuperBean{
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	...
    	String execSQL="select b.enterOrg as shareEnterOrg, b.ownership as shareOwnership, b.propertyNo as sharePropertyNo, b.serialNo as shareSerialNo, " +
    			...
    			" a.caseNo, " +
    			" (substr(b.propertyNo,1,7) || '-' || substr(b.propertyNo,8)) as propertyNo, " +
    			" b.serialNo, "+
    			" d.propertyName, " +
    			" nvl(b.specification,'1')specification,nvl(b.nameplate,'1')nameplate, " +
        ...
        while(rs.next()){
            ...
            String nameplate = "";
            if(!"1".equals(rs.getString("specification"))){
            	System.out.println("a");
            	specification = rs.getString("specification");
            }
            if(!"1".equals(rs.getString("nameplate"))){
            	System.out.println("b");
            	nameplate = rs.getString("nameplate");
            }
            data[8] = specification + "\n\\" + nameplate;
