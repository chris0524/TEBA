...
public class UNTMP014Q extends SuperBean2{
    ...
    public String getQ_dealCaseNo(){ return checkGet(q_dealCaseNo); }
    public void setQ_dealCaseNo(String s){ q_dealCaseNo=checkSet(s); }
