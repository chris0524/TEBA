...
public class UNTMP005F extends UNTMP001Q{
	...
	protected String[][] getInsertCheckSQL(){
		...
		ResultSet rs;	
		String sql="select max((serialNo1))+1 as serialNo1 from UNTMP_Attachment2 where 1=1 " +
	...
	protected String[] getInsertSQL(){
		...
		execSQLArray[0]=" insert into UNTMP_Attachment2(" +
			...
			" )Values(" +
				...
				Common.sqlChar(new UNTCH_Tools()._transToCE_Year(buyDate)) + "," +
	...
	*/
	...
	public UNTMP005F  queryOne() throws Exception{
		Database db = new Database();
		UNTMP005F obj = this;
		try {
			String sql=" select a.* "+
			...
			if (rs.next()){
				...
				obj.setSourceKind(Common.get(rs.getString("sourcekind")));
				obj.setNameplate(Common.get(rs.getString("nameplate")));
				obj.setSpecification(Common.get(rs.getString("specification")));
			}
