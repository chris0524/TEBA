...
public class UNTMP049R extends SuperBean{
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	...
    	String execSQL=" select c.organaName, b.adjustbookamount, b.oldbookamount, b.oldbookunit, d.propertyname, " +
		    			...
		    			" substr(b.propertyNo,0,7)||'-'||substr(b.propertyNo,8,2)||'-'||b.serialNo as propertyNo1," +
        ...
        while(rs.next()){
        	...
        	data[0] = "    "+"("+rs.getString("organaName")+")"+"經管"+rs.getString("ownershipName")+"動產遺失、毀損、意外事故報損(廢)查核報告表";
        	...
        	data[11] = rs.getString("scrapValue");
