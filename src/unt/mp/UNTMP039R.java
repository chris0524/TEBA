...
public class UNTMP039R extends SuperBean{
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	...
    	String[] columns = new String[] {"OWNERSHIP","ENTERORGNAME","CASENO","PROPERTYNO","PROPERTYNAME","SPECIFICATION","BUYDATE","LIMITYEAR","USEYEAR","PROPERTYUNIT","ADJUSTBOOKAMOUNT","OLDBOOKUNIT","ADJUSTBOOKVALUE","CAUSE2"};
    	...
    	execSQL1=execSQL1+" and d.propertyType='1' and b.cause='04'";
        ...
        while(rs.next()){
            ...
            //data[14] = "失竊人            使用單位(人員)            財產管理單位(人員)             會計單位(人員)            機關首長";
