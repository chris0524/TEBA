...
public class UNTDU037F extends QueryBean{
...
public UNTDU037F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo ,a.propertyNo ,a.serialNo " + "\n"
				   ...
				   + "  	  ,keeper ,useUnit ,userNo ,place ,notes" + "\n"
				   + "  	  ,closing ,otherMaterial ,otherPropertyUnit ,otherLimitYear" + "\n"
				   + "  	  ,oldPropertyNo ,oldSerialNo " + "\n"
				   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTNE_AdjustDetail a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
