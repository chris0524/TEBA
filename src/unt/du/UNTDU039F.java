...
public class UNTDU039F extends QueryBean{
...
public String getBuyDate(){ return checkGet(buyDate); }	public void setBuyDate(String s){ buyDate=checkSet(s); }
...
public String getOldBookAmount(){ return checkGet(oldBookAmount); }	public void setOldBookAmount(String s){ oldBookAmount=checkSet(s); }
...
public String getAdjustBookAmount(){ return checkGet(adjustBookAmount); }	public void setAdjustBookAmount(String s){ adjustBookAmount=checkSet(s); }
...
public String getNewBookAmount(){ return checkGet(newBookAmount); }	public void setNewBookAmount(String s){ newBookAmount=checkSet(s); }
public String getNewBookValue(){ return checkGet(newBookValue); }	public void setNewBookValue(String s){ newBookValue=checkSet(s); }
public String getArticleName(){ return checkGet(articleName); }	public void setArticleName(String s){ articleName=checkSet(s); }
public String getNameplate(){ return checkGet(nameplate); }	public void setNameplate(String s){ nameplate=checkSet(s); }
public String getSpecification(){ return checkGet(specification); }	public void setSpecification(String s){ specification=checkSet(s); }
public String getLicensePlate(){ return checkGet(licensePlate); }	public void setLicensePlate(String s){ licensePlate=checkSet(s); }
public String getMoveDate(){ return checkGet(moveDate); }	public void setMoveDate(String s){ moveDate=checkSet(s); }
...
public String getReturnPlace(){ return checkGet(returnPlace); }	public void setReturnPlace(String s){ returnPlace=checkSet(s); }
public String getCause2(){ return checkGet(cause2); }	public void setCause2(String s){ cause2=checkSet(s); }
public String getScrapValue2(){ return checkGet(scrapValue2); }	public void setScrapValue2(String s){ scrapValue2=checkSet(s); }
public String getDealSuggestion(){ return checkGet(dealSuggestion); }	public void setDealSuggestion(String s){ dealSuggestion=checkSet(s); }
...
public String getDealCaseNo(){ return checkGet(dealCaseNo); }	public void setDealCaseNo(String s){ dealCaseNo=checkSet(s); }
public String getDealDate(){ return checkGet(dealDate); }	public void setDealDate(String s){ dealDate=checkSet(s); }
public String getReduceDeal(){ return checkGet(reduceDeal); }	public void setReduceDeal(String s){ reduceDeal=checkSet(s); }
public String getRealizeValue(){ return checkGet(realizeValue); }	public void setRealizeValue(String s){ realizeValue=checkSet(s); }
public String getShiftOrg(){ return checkGet(shiftOrg); }	public void setShiftOrg(String s){ shiftOrg=checkSet(s); }
...
public String getComputerType(){ return checkGet(computerType); }	public void setComputerType(String s){ computerType=checkSet(s); }
...
String shiftOrgName;
public String getShiftOrgName(){ return checkGet(shiftOrgName); }	public void setShiftOrgName(String s){ shiftOrgName=checkSet(s); }

//傳回update sql
protected String[] getUpdateSQL(){
	String[] execSQLArray = new String[1];
	execSQLArray[0] = " update UNTMP_ReduceDetail set "
...
public UNTDU039F queryOne() throws Exception{
	Database db = new Database();
	UNTDU039F obj = this;
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo ,a.propertyNo ,a.serialNo " + "\n"
				   + " 		  ,propertyName1 ,otherMaterial ,otherPropertyUnit ,otherLimitYear ,enterDate" + "\n"
				   + " 		  ,buyDate ,cause ,cause1 ,reduceDate ,newEnterOrg ,transferDate" + "\n"
				   + " 		  ,verify ,propertyKind ,fundType ,valuable ,bookNotes ,accountingTitle" + "\n"
				   + " 		  ,oldBookAmount ,oldBookUnit ,oldBookValue ,adjustBookAmount ,adjustBookValue" + "\n"
				   + " 		  ,newBookAmount ,newBookValue ,articleName ,nameplate ,specification" + "\n"
				   + " 		  ,licensePlate ,moveDate ,keepUnit ,keeper ,useUnit ,userNo ,place " + "\n"
				   + " 		  ,returnPlace ,cause2 ,scrapValue2 ,dealSuggestion ,scrapValue" + "\n"
				   + " 		  ,apportionYear ,useEndYM ,dealCaseNo ,dealDate ,reduceDeal" + "\n"
				   + " 		  ,realizeValue ,shiftOrg ,sourceDate ,useYear ,useMonth" + "\n"
				   + " 		  ,deprMethod ,deprAmount ,monthDepr ,apportionEndYM ,accumDeprYM" + "\n"
				   + " 		  ,accumDepr ,permitReduceDate ,accumdepr1 ,scrapValue1 ,submitCityGov" + "\n"
				   + " 		  ,notes ,closing ,oldPropertyNo ,oldSerialNo ,computerType" + "\n"
				   + "		  ,( select x.organsname from sysca_organ x where 1=1 and x.organid = a.newEnterOrg ) as newEnterOrgName" + "\n"
				   + "		  ,( select x.organsname from sysca_organ x where 1=1 and x.organid = a.shiftOrg ) as shiftOrgName" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTMP_ReduceDetail a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
