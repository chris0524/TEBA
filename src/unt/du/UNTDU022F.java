...
public class UNTDU022F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTBU_AddProof set "
...
public UNTDU022F queryOne() throws Exception{
	Database db = new Database();
	UNTDU022F obj = this;
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
		   		   + " 		  ,caseName ,writeDate ,writeUnit ,proofDoc ,proofNo ,manageNo " + "\n"
		   		   + " 		  ,summonsNo ,enterDate ,verify ,closing ,notes " + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTBU_AddProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
