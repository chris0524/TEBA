...
public class UNTDU033F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTMP_ReduceProof set "
...
public UNTDU033F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " 		  ,manageNo ,summonsNo ,reduceDate ,approveOrg ,approveDate " + "\n"
				   + " 		  ,approveDoc ,verify ,notes ,closing" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTMP_ReduceProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
