...
public class UNTDU002F extends SuperBean{
...
protected String[] getUpdateSQL(){
	...
	signNo=signNo1.substring(0,1)+signNo2.substring(1,3)+signNo3.substring(3,7)+signNo4+signNo5;
...
//	}else{
		execSQLArray[0]=" update UNTBU_Building set " +
			...
			" and serialNo = " + Common.sqlChar(SerialNo) +
			"";
		execSQLArray[1]=" update UNTBU_ReduceDetail set " +
			" signNo = " + Common.sqlChar(signNo) + 
			" where 1=1 " + 
			" and enterOrg = " + Common.sqlChar(enterOrg) +
			" and ownership = " + Common.sqlChar(ownership) +
			...
			" and serialNo = " + Common.sqlChar(SerialNo) +
			"";
		execSQLArray[2]=" update UNTBU_AdjustDetail set " +
			" signNo = " + Common.sqlChar(signNo) + 
			" where 1=1 " + 
			" and enterOrg = " + Common.sqlChar(enterOrg) +
			" and ownership = " + Common.sqlChar(ownership) +
...
public UNTDU002F  queryOne() throws Exception{
