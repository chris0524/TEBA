...
public class UNTDU024F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTBU_ReduceProof set "
...
public UNTDU024F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " ,reduceDate ,approveOrg ,approveDate ,approveDoc ,verify" + "\n"
				   + " ,notes ,closing" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTBU_ReduceProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
