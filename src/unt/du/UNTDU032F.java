...
public class UNTDU032F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTMP_AdjustProof set "
...
public UNTDU032F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " 		  ,manageNo ,summonsNo ,adjustDate ,approveOrg" + "\n"
				   + " 		  ,approveDate ,approveDoc ,verify ,notes ,closing" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTMP_AdjustProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
