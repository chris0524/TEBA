...
public class UNTDU023F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update untbu_adjustproof set "
...
public UNTDU023F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " ,approveDoc ,verify ,notes ,closing" + "\n"
		   		   ...
		   		   + " from untbu_adjustproof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
