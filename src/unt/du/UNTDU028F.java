...
public class UNTDU028F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTNE_AddProof set "
...
public UNTDU028F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " 		  ,manageNo ,summonsNo ,enterDate ,verify ,closing" + "\n"
				   + " 		  ,notes" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTNE_AddProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
