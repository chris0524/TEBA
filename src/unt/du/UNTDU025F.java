...
public class UNTDU025F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTRF_AddProof set "
...
public UNTDU025F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
		   		   ...
		   		   + " ,manageNo ,summonsNo ,enterDate ,verify" + "\n"
		   		   + " ,closing ,notes " + "\n"
				   + " 		  ,a.enterDate " + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTRF_AddProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
