...
public class UNTDU031F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTMP_AddProof set "
...
public UNTDU031F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " 		  ,notes " + "\n"
		   		   ...
		   		   + " from UNTMP_AddProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
