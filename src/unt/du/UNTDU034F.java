...
public class UNTDU034F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTLA_AdjustProof set "
...
public UNTDU034F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " 		 ,a.manageNo ,a.summonsNo ,a.adjustDate ,a.approveOrg ,a.approveDate " + "\n"
				   + " 		 ,a.approveDoc ,a.verify ,a.notes" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTLA_AdjustProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
