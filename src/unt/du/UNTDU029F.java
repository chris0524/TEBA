...
public class UNTDU029F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTNE_AdjustProof set "
...
public UNTDU029F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " ,approveDoc ,verify ,notes ,closing" + "\n"
		   		   ...
		   		   + " from UNTNE_AdjustProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
