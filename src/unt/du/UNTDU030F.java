...
public class UNTDU030F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTNE_ReduceProof set "
...
public UNTDU030F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + "		  ,manageNo ,summonsNo ,reduceDate ,approveOrg" + "\n"
				   + " 		  ,approveDate ,approveDoc ,verify ,notes ,closing" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTNE_ReduceProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
