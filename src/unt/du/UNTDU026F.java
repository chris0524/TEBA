...
public class UNTDU026F extends QueryBean{
...
protected String[] getUpdateSQL(){
	...
	execSQLArray[0] = " update UNTRF_AdjustProof set "
...
public UNTDU026F queryOne() throws Exception{
	...
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   ...
				   + " ,manageNo ,summonsNo ,adjustDate ,approveOrg ,approveDate" + "\n"
				   + " ,approveDoc ,verify ,notes ,closing" + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTRF_AdjustProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
