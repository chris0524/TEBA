...
public class UNTDU015F extends QueryBean{
...
public UNTDU015F queryOne() throws Exception{
	Database db = new Database();
	UNTDU015F obj = this;
	try {
		String sql = " select a.enterOrg ,o.organsname as enterOrgName ,a.ownership ,a.caseNo " + "\n"
				   + " 		  ,caseName ,writeDate ,writeUnit ,proofDoc ,proofNo ,manageNo ,summonsNo ,enterDate " + "\n"
				   + " 		  ,mergeDivision ,verify ,closing ,notes " + "\n"
		   		   + " 		  ,a.editid ,a.editDate ,a.editTime " + "\n"
		   		   + " from UNTLA_AddProof a ,sysca_organ o " + "\n"
		   		   + " where 1=1 " + "\n"
