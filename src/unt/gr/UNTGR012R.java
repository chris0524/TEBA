...
public class UNTGR012R extends SuperBean{
...
public DefaultTableModel getResultModel() throws Exception{
    ...
    try{
    	//執行SQL File檔案
    	Common.callSQLFile(getFileName()+"\\untgr010r.sql "+getEditID()+" "+getQ_enterOrg()+" "+getQ_enterDateS()+" "+getQ_enterDateE()+querySQL+" N "+getQ_ownership()+" UNTGR_untgr012r"+" 99 1"+" "+getIsorganmanagerT());
    	// iReport 中column的名稱----COLUMNS_1,COLUMNS_2,COLUMNS_3.......,COLUMNS_15
    	...
    	//==========================================
    	//抓取存在於UNTGR_untgr012r中的資料
    	String execSQL= Common.callSQLFileRead(getFileName()+"\\untgr010r_1.sql",2,getEditID()+":;:UNTGR_untgr012r");
    	//==========================================
    	String[] SQLName = new String[] {"propertyNo1","propertyNo2","propertyNo3","propertyNo4","propertyNo5","propertyName","propertyUnit","oldAmountOldArea","addAmountAddArea","reduceAmountReduceArea","nowAmountNowArea","nowBookValue","nowAppraiseValue","nowaccumDepr","nowBookValue1","propertyKindFundTypeName","propertyKindFundTypeNo"};
    	...
    	while(rs.next()){
    		...
    		if(q_ownership.equals("4")){
            	data[(column)+4] = "製表                                                             財產經管人員                                                              主辦會計人員                                                              機關首長(召集人或其授權代簽人)";
            }else{
            	data[(column)+4] = "製表                              覆核                                       財產經管人員                                       主辦事務人員                                       主辦會計人員                                      機關首長";
            }
