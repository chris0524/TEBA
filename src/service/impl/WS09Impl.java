...
public class WS09Impl implements WS09 {
	 private String enterorg;  
	 private String AuthCode;

	 @Override
	public String Query_differenceKind(String enterorg,String AuthCode) throws Exception  {
			...
			try
			 {
				SqlStr=" select "+
				" a.codeid,a.codename "+ 
				"from SYSCA_CODE a where 1=1 and codekindid ='DFK' order by a.codeid";
			  ...
			  if(rs.next()){
					...
					while(rs.next()){
						HashMap rows=new HashMap();
					 	rows.put("codeid",checkGet(rs.getString("codeid")));//
					 	rows.put("codename",checkGet(rs.getString("codename")));//
